...
const _sfc_main$2 = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<!--[--><ul class="navbar-nav" data-v-2821dd4d><!--[-->`);
      ssrRenderList(menus.value, (menu, index) => {
        _push(`<!--[-->`);
        if (menu.type === "divider") {
          _push(`<li class="nav-item mt-3" data-v-2821dd4d><h6 class="text-uppercase font-weight-bolder opacity-6 ms-2 ps-4 text-xs" data-v-2821dd4d>${ssrInterpolate(menu.name)}</h6></li>`);
        } else if (menu.children && menu.children.length > 0) {
          _push(`<li class="nav-item" data-v-2821dd4d><a href="javascript:void(0)" class="${ssrRenderClass([
            "nav-link d-flex align-items-center",
            {
              "active bg-gradient-primary text-white": hasActiveChild(menu.children),
              "text-dark": !hasActiveChild(menu.children)
            }
          ])}" data-v-2821dd4d><div class="${ssrRenderClass([
          ...
          ])}" data-v-2821dd4d><i class="${ssrRenderClass([
            menu.icon,
            {
              "text-dark": !hasActiveChild(menu.children),
              "text-white": hasActiveChild(menu.children)
            }
          ])}" data-v-2821dd4d></i></div><span class="nav-link-text grow-1 ms-1" data-v-2821dd4d>${ssrInterpolate(menu.name)}</span><i class="${ssrRenderClass([
          ...
          ])}" data-v-2821dd4d></i></a><div class="${ssrRenderClass([
            "collapse",
            {
              show: shouldOpenDropdown(index, menu.children)
            }
          ])}" data-v-2821dd4d><ul style="${ssrRenderStyle({ "list-style": "none" })}" class="flex-column ms-3 mt-1" data-v-2821dd4d><!--[-->`);
          ssrRenderList(menu.children, (child, cIndex) => {
            _push(`<li class="nav-item" data-v-2821dd4d>`);
            _push(ssrRenderComponent(unref(Link), {
              ...
              default: withCtx((_, _push2, _parent2, _scopeId) => {
                if (_push2) {
                  ...
                  ])}" style="${ssrRenderStyle({ "width": "28px", "height": "28px" })}" data-v-2821dd4d${_scopeId}><i class="${ssrRenderClass([
                    child.icon,
                    {
                      "text-dark": !isActive(
                        child.route
                  ...
                  ])}" data-v-2821dd4d${_scopeId}></i></div><span class="nav-link-text ms-1" data-v-2821dd4d${_scopeId}>${ssrInterpolate(child.name)}</span>`);
                } else {
                  return [
                    createVNode("div", {
                      class: [
          ...
          _push(ssrRenderComponent(unref(Link), {
            ...
            default: withCtx((_, _push2, _parent2, _scopeId) => {
              if (_push2) {
                ...
                ])}" data-v-2821dd4d${_scopeId}><i class="${ssrRenderClass([
                  menu.icon,
                  {
                    "text-dark": !isActive(menu.route),
                    "text-white": isActive(menu.route)
                  }
                ])}" data-v-2821dd4d${_scopeId}></i></div><span class="nav-link-text ms-1" data-v-2821dd4d${_scopeId}>${ssrInterpolate(menu.name)}</span>`);
              } else {
                return [
                  createVNode("div", {
                    class: [
      ...
      _push(`<!--]-->`);
      if (canOptimize.value) {
        _push(`<li class="nav-item mt-4" data-v-2821dd4d><button${ssrIncludeBooleanAttr(isOptimizing.value) ? " disabled" : ""} class="${ssrRenderClass([
          "nav-link d-flex align-items-center w-100",
          {
            "cursor-not-allowed opacity-50": isOptimizing.value,
            "text-dark": !isOptimizing.value
          }
        ])}" style="${ssrRenderStyle({ "border": "none", "background": "transparent", "text-align": "left" })}" data-v-2821dd4d><div class="${ssrRenderClass([
          "icon icon-shape icon-sm border-radius-md d-flex align-items-center justify-content-center me-2 text-center shadow",
          {
        ...
        ])}" data-v-2821dd4d></i></div><span class="nav-link-text ms-1" data-v-2821dd4d>${ssrInterpolate(isOptimizing.value ? "Optimizing..." : "Refresh Halaman")}</span></button></li>`);
      } else {
        _push(`<!---->`);
      }
      _push(`</ul>`);
      if (showOptimizeConfirm.value) {
        _push(`<div class="modal fade show d-block" style="${ssrRenderStyle({ "background-color": "rgba(0, 0, 0, 0.5)" })}" data-v-2821dd4d><div class="modal-dialog modal-dialog-centered" data-v-2821dd4d><div class="modal-content" data-v-2821dd4d><div class="modal-header" data-v-2821dd4d><h5 class="modal-title" data-v-2821dd4d><i class="fas fa-sync-alt me-2" data-v-2821dd4d></i> Konfirmasi Refresh Halaman </h5><button type="button" class="btn-close" data-v-2821dd4d></button></div><div class="modal-body" data-v-2821dd4d><p data-v-2821dd4d>Apakah Anda yakin ingin menjalankan optimasi sistem?</p><div class="alert alert-info" data-v-2821dd4d><i class="fas fa-info-circle me-2" data-v-2821dd4d></i><strong data-v-2821dd4d>Informasi:</strong><ul class="mb-0 mt-2" data-v-2821dd4d><li data-v-2821dd4d> Proses ini akan menjalankan <code data-v-2821dd4d>php artisan optimize</code></li><li data-v-2821dd4d> Halaman akan otomatis refresh setelah optimasi selesai </li><li data-v-2821dd4d> Mungkin memerlukan beberapa detik untuk menyelesaikan </li></ul></div>`);
        if (optimizeStatus.value) {
          _push(`<div class="mt-3" data-v-2821dd4d><small class="text-muted" data-v-2821dd4d><strong data-v-2821dd4d>Rate Limit:</strong> ${ssrInterpolate(optimizeStatus.value.rate_limit_remaining)} dari 3 percobaan tersisa </small></div>`);
        } else {
          _push(`<!---->`);
        }
        _push(`</div><div class="modal-footer" data-v-2821dd4d><button type="button" class="btn btn-secondary" data-v-2821dd4d><i class="fas fa-times me-2" data-v-2821dd4d></i> Batal </button><button type="button" class="btn btn-primary" data-v-2821dd4d><i class="fas fa-sync-alt me-2" data-v-2821dd4d></i> Ya, Refresh Sekarang </button></div></div></div></div>`);
      } else {
        _push(`<!---->`);
      }
      _push(`<!--]-->`);
...
const Sidebar = /* @__PURE__ */ _export_sfc(_sfc_main$2, [["__scopeId", "data-v-2821dd4d"]]);
const toasts = ref();
