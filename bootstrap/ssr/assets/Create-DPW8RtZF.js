import { ref, computed, watch, unref, withCtx, createBlock, openBlock, createVNode, createTextVNode, withModifiers, withDirectives, Fragment, renderList, toDisplayString, vModelSelect, vModelText, createCommentVNode, useSSRContext } from "vue";
...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(_sfc_main$1, { title: "Tambah Produk" }, {
        header: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div class="flex items-center justify-between"${_scopeId}><h2 class="text-xl font-semibold leading-tight text-gray-800"${_scopeId}> Tambah Produk </h2>`);
            ...
            return [
              createVNode("div", { class: "flex items-center justify-between" }, [
                createVNode("h2", { class: "text-xl font-semibold leading-tight text-gray-800" }, " Tambah Produk "),
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            _push2(`<select name="product_type" id="product_type" class="form-select" required${_scopeId}><option${ssrRenderAttr("value", null)} disabled${ssrIncludeBooleanAttr(Array.isArray(unref(form).product_type) ? ssrLooseContain(unref(form).product_type, null) : ssrLooseEqual(unref(form).product_type, null)) ? " selected" : ""}${_scopeId}> Pilih Tipe Produk </option><!--[-->`);
            ...
            if (targetSellingDays.value && parseInt(targetSellingDays.value) > MAX_SELLING_DAYS) {
              _push2(`<small class="text-danger"${_scopeId}>Maksimal ${ssrInterpolate(MAX_SELLING_DAYS)} hari (±10 tahun)</small>`);
            } else {
              _push2(`<small class="text-muted"${_scopeId}>Calculated date: ${ssrInterpolate(calculatedTargetDate.value)}</small>`);
            }
            _push2(`</div><div class="mb-3"${_scopeId}>`);
            _push2(ssrRenderComponent(_sfc_main$2, {
              for: "expired_date",
            ...
            _push2(`<select id="m_property_item_id" class="form-select" required${_scopeId}><option${ssrRenderAttr("value", null)} disabled${ssrIncludeBooleanAttr(Array.isArray(unref(form).m_property_item_id) ? ssrLooseContain(unref(form).m_property_item_id, null) : ssrLooseEqual(unref(form).m_property_item_id, null)) ? " selected" : ""}${_scopeId}> Select Property Item </option><!--[-->`);
            ...
            _push2(`<select id="m_packaging_size_id" class="form-select" required${_scopeId}><option${ssrRenderAttr("value", null)} disabled${ssrIncludeBooleanAttr(Array.isArray(unref(form).m_packaging_size_id) ? ssrLooseContain(unref(form).m_packaging_size_id, null) : ssrLooseEqual(unref(form).m_packaging_size_id, null)) ? " selected" : ""}${_scopeId}> Select Packaging Size </option><!--[-->`);
            ...
            _push2(`<select id="m_packaging_type_id" class="form-select" required${_scopeId}><option${ssrRenderAttr("value", null)} disabled${ssrIncludeBooleanAttr(Array.isArray(unref(form).m_packaging_type_id) ? ssrLooseContain(unref(form).m_packaging_type_id, null) : ssrLooseEqual(unref(form).m_packaging_type_id, null)) ? " selected" : ""}${_scopeId}> Select Packaging Type </option><!--[-->`);
            ...
            _push2(`<select id="m_repack_status_id" class="form-select" required${_scopeId}><option${ssrRenderAttr("value", null)} disabled${ssrIncludeBooleanAttr(Array.isArray(unref(form).m_repack_status_id) ? ssrLooseContain(unref(form).m_repack_status_id, null) : ssrLooseEqual(unref(form).m_repack_status_id, null)) ? " selected" : ""}${_scopeId}> Select Repack Status </option><!--[-->`);
            ...
            if (imagePreview.value.length > 0) {
              _push2(`<div class="mb-3"${_scopeId}><h6${_scopeId}>Preview Gambar:</h6><div class="row"${_scopeId}><!--[-->`);
                    ...
                    createVNode("div", { class: "row" }, [
                      createVNode("div", { class: "col-md-8" }, [
                        ...
                        createVNode("div", { class: "mb-3" }, [
                          ...
                          targetSellingDays.value && parseInt(targetSellingDays.value) > MAX_SELLING_DAYS ? (openBlock(), createBlock("small", {
                            key: 0,
                            class: "text-danger"
                          }, "Maksimal " + toDisplayString(MAX_SELLING_DAYS) + " hari (±10 tahun)")) : (openBlock(), createBlock("small", {
                            key: 1,
                            class: "text-muted"
                          }, "Calculated date: " + toDisplayString(calculatedTargetDate.value), 1))
                        ]),
                        createVNode("div", { class: "mb-3" }, [
                          createVNode(_sfc_main$2, {
                            for: "expired_date",
                      ...
                      createVNode("div", { class: "col-md-4" }, [
                        ...
                        imagePreview.value.length > 0 ? (openBlock(), createBlock("div", {
                          ...
                          createVNode("h6", null, "Preview Gambar:"),
                          createVNode("div", { class: "row" }, [
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("resources/js/Pages/CoreProducts/Create.vue");
