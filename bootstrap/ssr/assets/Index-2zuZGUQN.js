...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    const isSortable = (field) => {
      const sortableFields = ["id", "packaging_type_code", "packaging_type_name", "created_at", "updated_at"];
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(_sfc_main$1, { title: "Daftar Tipe Kemasan" }, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div class="card mb-3" data-v-1772300c${_scopeId}><div class="card-body" data-v-1772300c${_scopeId}><div class="row g-3 align-items-end" data-v-1772300c${_scopeId}><div class="col-md-4" data-v-1772300c${_scopeId}><label class="form-label" data-v-1772300c${_scopeId}>Pencarian</label>`);
            ...
            _push2(`</div><div class="col-md-2" data-v-1772300c${_scopeId}>`);
            if (hasActiveFilters.value) {
              _push2(`<button class="btn btn-outline-secondary" data-v-1772300c${_scopeId}><i class="fas fa-times me-1" data-v-1772300c${_scopeId}></i> Clear </button>`);
            } else {
              _push2(`<!---->`);
            }
            _push2(`</div><div class="col-md-6 text-end" data-v-1772300c${_scopeId}><button class="btn btn-primary" data-v-1772300c${_scopeId}><i class="fas fa-plus me-1" data-v-1772300c${_scopeId}></i> Tambah Tipe Kemasan </button></div></div></div></div><div class="d-flex justify-content-between align-items-center mb-3" data-v-1772300c${_scopeId}><div class="text-muted" data-v-1772300c${_scopeId}> Menampilkan ${ssrInterpolate(__props.packaging_types.from || 0)} - ${ssrInterpolate(__props.packaging_types.to || 0)} dari ${ssrInterpolate(__props.packaging_types.total || 0)} data </div>`);
            if (hasActiveFilters.value) {
              _push2(`<div class="text-muted" data-v-1772300c${_scopeId}><i class="fas fa-filter me-1" data-v-1772300c${_scopeId}></i> Filter aktif </div>`);
            } else {
              _push2(`<!---->`);
            }
            _push2(`</div><div class="card" data-v-1772300c${_scopeId}><div class="table-responsive" data-v-1772300c${_scopeId}><table class="table-hover mb-0 table" data-v-1772300c${_scopeId}><thead class="table-light" data-v-1772300c${_scopeId}><tr data-v-1772300c${_scopeId}><th class="text-center" style="${ssrRenderStyle({ "width": "60px" })}" data-v-1772300c${_scopeId}>#</th><th class="${ssrRenderClass({
              sortable: isSortable("packaging_type_code")
            })}" style="${ssrRenderStyle({ "cursor": "pointer" })}" data-v-1772300c${_scopeId}> Kode Tipe Kemasan `);
            if (isSortable("packaging_type_code")) {
              _push2(`<i class="${ssrRenderClass([getSortIcon("packaging_type_code"), "ms-1"])}" data-v-1772300c${_scopeId}></i>`);
            } else {
              _push2(`<!---->`);
            }
            _push2(`</th><th class="${ssrRenderClass({
              sortable: isSortable("packaging_type_name")
            })}" style="${ssrRenderStyle({ "cursor": "pointer" })}" data-v-1772300c${_scopeId}> Nama Tipe Kemasan `);
            if (isSortable("packaging_type_name")) {
              _push2(`<i class="${ssrRenderClass([getSortIcon("packaging_type_name"), "ms-1"])}" data-v-1772300c${_scopeId}></i>`);
            } else {
              _push2(`<!---->`);
            }
            _push2(`</th><th data-v-1772300c${_scopeId}>Level Kemasan</th><th class="${ssrRenderClass({ sortable: isSortable("created_at") })}" style="${ssrRenderStyle({ "cursor": "pointer" })}" data-v-1772300c${_scopeId}> Tanggal Dibuat `);
            if (isSortable("created_at")) {
              _push2(`<i class="${ssrRenderClass([getSortIcon("created_at"), "ms-1"])}" data-v-1772300c${_scopeId}></i>`);
            } else {
              _push2(`<!---->`);
            }
            _push2(`</th><th class="text-center" style="${ssrRenderStyle({ "width": "120px" })}" data-v-1772300c${_scopeId}>Aksi</th></tr></thead><tbody data-v-1772300c${_scopeId}>`);
            if (__props.packaging_types.data && __props.packaging_types.data.length === 0) {
              _push2(`<tr data-v-1772300c${_scopeId}><td colspan="6" class="text-muted py-4 text-center" data-v-1772300c${_scopeId}><i class="fas fa-inbox fa-2x d-block mb-2" data-v-1772300c${_scopeId}></i>`);
              if (search.value) {
                _push2(`<div data-v-1772300c${_scopeId}>Tidak ada data yang sesuai dengan pencarian &quot;${ssrInterpolate(search.value)}&quot;</div>`);
              } else {
                _push2(`<div data-v-1772300c${_scopeId}>Belum ada data tipe kemasan</div>`);
              }
              _push2(`</td></tr>`);
            } else {
              _push2(`<!--[-->`);
              ssrRenderList(__props.packaging_types.data, (packaging_type, index) => {
                var _a;
                _push2(`<tr data-v-1772300c${_scopeId}><td class="text-muted text-center" data-v-1772300c${_scopeId}>${ssrInterpolate(__props.packaging_types.from + index)}</td><td data-v-1772300c${_scopeId}><span class="badge bg-secondary" data-v-1772300c${_scopeId}>${ssrInterpolate(packaging_type.packaging_type_code)}</span></td><td class="fw-medium" data-v-1772300c${_scopeId}>${ssrInterpolate(packaging_type.packaging_type_name)}</td><td data-v-1772300c${_scopeId}><span class="badge bg-info" data-v-1772300c${_scopeId}>${ssrInterpolate(((_a = packaging_type.packaging_level) == null ? void 0 : _a.level_description) || "N/A")}</span></td><td class="text-muted" data-v-1772300c${_scopeId}>${ssrInterpolate(new Date(packaging_type.created_at).toLocaleDateString("id-ID", {
                  year: "numeric",
                  month: "short",
                  day: "numeric"
                }))}</td><td class="text-center" data-v-1772300c${_scopeId}><div class="btn-group btn-group-md" role="group" data-v-1772300c${_scopeId}><button class="btn btn-outline-warning" title="Edit Tipe Kemasan" data-v-1772300c${_scopeId}><i class="fas fa-edit" data-v-1772300c${_scopeId}></i></button><button class="btn btn-outline-danger" title="Hapus Tipe Kemasan" data-v-1772300c${_scopeId}><i class="fas fa-trash" data-v-1772300c${_scopeId}></i></button></div></td></tr>`);
              });
              _push2(`<!--]-->`);
            }
            _push2(`</tbody></table></div></div><div class="mt-3" data-v-1772300c${_scopeId}>`);
            ...
            return [
              ...
              createVNode("div", { class: "d-flex justify-content-between align-items-center mb-3" }, [
                createVNode("div", { class: "text-muted" }, " Menampilkan " + toDisplayString(__props.packaging_types.from || 0) + " - " + toDisplayString(__props.packaging_types.to || 0) + " dari " + toDisplayString(__props.packaging_types.total || 0) + " data ", 1),
                    ...
                    createVNode("tbody", null, [
                      __props.packaging_types.data && __props.packaging_types.data.length === 0 ? (openBlock(), createBlock("tr", { key: 0 }, [
                        ...
                        return openBlock(), createBlock("tr", {
                          ...
                          createVNode("td", { class: "text-muted" }, toDisplayString(new Date(packaging_type.created_at).toLocaleDateString("id-ID", {
                            year: "numeric",
                            month: "short",
                            day: "numeric"
                          })), 1),
                          createVNode("td", { class: "text-center" }, [
                            createVNode("div", {
                              ...
                              createVNode("button", {
                                onClick: ($event) => openEditPackagingType(packaging_type),
                              ...
                              createVNode("button", {
                                onClick: ($event) => deletePackagingType(packaging_type.id),
...
const Index = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-1772300c"]]);
export {
  Index as default
};
