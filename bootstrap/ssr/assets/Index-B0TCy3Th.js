...
import ProductionModal from "./ProductionModal-SX8hlSqd.js";
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(_sfc_main$1, { title: "Produksi" }, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div class="overflow-hidden bg-white shadow-sm sm:rounded-lg" data-v-6d6bb1b9${_scopeId}><div class="p-3 text-gray-900" data-v-6d6bb1b9${_scopeId}><div class="d-flex justify-content-between align-items-center mb-3" data-v-6d6bb1b9${_scopeId}><div class="d-flex align-items-center gap-3" data-v-6d6bb1b9${_scopeId}>`);
            ...
            _push2(`</div><button class="btn btn-primary" data-v-6d6bb1b9${_scopeId}><i class="fas fa-plus me-1" data-v-6d6bb1b9${_scopeId}></i> Produksi </button></div>`);
            if (__props.products.data.length > 0) {
              _push2(`<div class="table-responsive" data-v-6d6bb1b9${_scopeId}><table class="table-bordered table-striped table" data-v-6d6bb1b9${_scopeId}><thead class="table-light" data-v-6d6bb1b9${_scopeId}><tr data-v-6d6bb1b9${_scopeId}><th style="${ssrRenderStyle({ "width": "60px" })}" data-v-6d6bb1b9${_scopeId}>No.</th><th data-v-6d6bb1b9${_scopeId}>Nama Produk</th><th data-v-6d6bb1b9${_scopeId}>Deskripsi (Bahan Baku)</th><th style="${ssrRenderStyle({ "width": "120px" })}" data-v-6d6bb1b9${_scopeId}>Qty</th><th style="${ssrRenderStyle({ "width": "150px" })}" data-v-6d6bb1b9${_scopeId}>PIC</th><th style="${ssrRenderStyle({ "width": "180px" })}" data-v-6d6bb1b9${_scopeId}>Tanggal</th></tr></thead><tbody data-v-6d6bb1b9${_scopeId}><!--[-->`);
              ssrRenderList(__props.products.data, (log, index) => {
                var _a2, _b;
                _push2(`<tr data-v-6d6bb1b9${_scopeId}><td data-v-6d6bb1b9${_scopeId}>${ssrInterpolate(getRowNumber(index))}</td><td data-v-6d6bb1b9${_scopeId}>${ssrInterpolate(((_a2 = log.product) == null ? void 0 : _a2.product_name) || "-")}</td><td data-v-6d6bb1b9${_scopeId}><small class="text-muted" data-v-6d6bb1b9${_scopeId}>${ssrInterpolate(formatDescription(log.description))}</small></td><td class="text-center" data-v-6d6bb1b9${_scopeId}><span class="badge bg-info" data-v-6d6bb1b9${_scopeId}>${ssrInterpolate(log.quantity)}</span></td><td data-v-6d6bb1b9${_scopeId}>${ssrInterpolate(((_b = log.created_by) == null ? void 0 : _b.name) || "-")}</td><td data-v-6d6bb1b9${_scopeId}>${ssrInterpolate(formatDate(log.created_at))}</td></tr>`);
              });
            ...
            if (__props.products.data.length === 0) {
              _push2(`<div class="py-4 text-center" data-v-6d6bb1b9${_scopeId}><p class="text-muted" data-v-6d6bb1b9${_scopeId}>Tidak ada log produksi ditemukan.</p></div>`);
            } else {
              _push2(`<!---->`);
            }
...
const Index = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-6d6bb1b9"]]);
export {
  Index as default
};
