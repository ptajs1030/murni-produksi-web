    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(_sfc_main$1, { title: "Daftar Property Item" }, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div class="overflow-hidden bg-white shadow-sm sm:rounded-lg" data-v-2582585f${_scopeId}><div class="p-3 text-gray-900" data-v-2582585f${_scopeId}><div class="d-flex justify-content-between align-items-center mb-3" data-v-2582585f${_scopeId}><div class="d-flex align-items-center gap-3" data-v-2582585f${_scopeId}>`);
            ...
            if (hasActiveFilters.value) {
              _push2(`<button class="btn btn-outline-secondary" data-v-2582585f${_scopeId}><i class="fas fa-times me-1" data-v-2582585f${_scopeId}></i> Clear </button>`);
            } else {
              _push2(`<!---->`);
            }
            _push2(`</div><div class="d-flex gap-2" data-v-2582585f${_scopeId}><button class="btn btn-outline-success" data-v-2582585f${_scopeId}><i class="fas fa-file-import me-1" data-v-2582585f${_scopeId}></i> Import </button><button class="btn btn-primary" data-v-2582585f${_scopeId}><i class="fas fa-plus me-1" data-v-2582585f${_scopeId}></i> Tambah Property Item </button></div></div></div></div><div class="card" data-v-2582585f${_scopeId}><div class="table-responsive" data-v-2582585f${_scopeId}><table class="table-hover mb-0 table" data-v-2582585f${_scopeId}><thead class="table-light" data-v-2582585f${_scopeId}><tr data-v-2582585f${_scopeId}><th class="text-center" style="${ssrRenderStyle({ "width": "60px" })}" data-v-2582585f${_scopeId}>#</th><th class="${ssrRenderClass({
              sortable: isSortable("property_code")
            })}" style="${ssrRenderStyle({ "cursor": "pointer" })}" data-v-2582585f${_scopeId}> Kode Property `);
            if (isSortable("property_code")) {
              _push2(`<i class="${ssrRenderClass([getSortIcon("property_code"), "ms-1"])}" data-v-2582585f${_scopeId}></i>`);
            } else {
              _push2(`<!---->`);
            }
            _push2(`</th><th class="${ssrRenderClass({
              sortable: isSortable("property_name")
            })}" style="${ssrRenderStyle({ "cursor": "pointer" })}" data-v-2582585f${_scopeId}> Nama Property `);
            if (isSortable("property_name")) {
              _push2(`<i class="${ssrRenderClass([getSortIcon("property_name"), "ms-1"])}" data-v-2582585f${_scopeId}></i>`);
            } else {
              _push2(`<!---->`);
            }
            _push2(`</th><th class="${ssrRenderClass({ sortable: isSortable("created_at") })}" style="${ssrRenderStyle({ "cursor": "pointer" })}" data-v-2582585f${_scopeId}> Tanggal Dibuat `);
            if (isSortable("created_at")) {
              _push2(`<i class="${ssrRenderClass([getSortIcon("created_at"), "ms-1"])}" data-v-2582585f${_scopeId}></i>`);
            } else {
              _push2(`<!---->`);
            }
            _push2(`</th><th class="text-center" style="${ssrRenderStyle({ "width": "120px" })}" data-v-2582585f${_scopeId}> Aksi </th></tr></thead><tbody data-v-2582585f${_scopeId}>`);
            if (__props.propertyItems.data && __props.propertyItems.data.length === 0) {
              _push2(`<tr data-v-2582585f${_scopeId}><td colspan="5" class="text-muted py-4 text-center" data-v-2582585f${_scopeId}><i class="fas fa-inbox fa-2x d-block mb-2" data-v-2582585f${_scopeId}></i>`);
              if (search.value) {
                _push2(`<div data-v-2582585f${_scopeId}> Tidak ada data yang sesuai dengan pencarian &quot;${ssrInterpolate(search.value)}&quot; </div>`);
              } else {
                _push2(`<div data-v-2582585f${_scopeId}>Belum ada data property item</div>`);
              }
              _push2(`</td></tr>`);
            } else {
              _push2(`<!--[-->`);
              ssrRenderList(__props.propertyItems.data, (propertyItem, index) => {
                _push2(`<tr data-v-2582585f${_scopeId}><td class="text-muted text-center" data-v-2582585f${_scopeId}>${ssrInterpolate(__props.propertyItems.from + index)}</td><td data-v-2582585f${_scopeId}><span class="badge bg-secondary" data-v-2582585f${_scopeId}>${ssrInterpolate(propertyItem.property_code)}</span></td><td class="fw-medium" data-v-2582585f${_scopeId}>${ssrInterpolate(propertyItem.property_name)}</td><td class="text-muted" data-v-2582585f${_scopeId}>${ssrInterpolate(new Date(
                  propertyItem.created_at
                ).toLocaleDateString("id-ID", {
                  year: "numeric",
                  month: "short",
                  day: "numeric"
                }))}</td><td class="text-center" data-v-2582585f${_scopeId}><div class="btn-group btn-group-md" role="group" data-v-2582585f${_scopeId}><button class="btn btn-outline-warning" title="Edit Property Item" data-v-2582585f${_scopeId}><i class="fas fa-edit" data-v-2582585f${_scopeId}></i></button><button class="btn btn-outline-danger" title="Hapus Property Item" data-v-2582585f${_scopeId}><i class="fas fa-trash" data-v-2582585f${_scopeId}></i></button></div></td></tr>`);
              });
              _push2(`<!--]-->`);
            }
            _push2(`</tbody></table></div></div><div class="mt-3" data-v-2582585f${_scopeId}>`);
            ...
            if (showImportModal.value) {
              _push2(`<div class="modal-backdrop fade show" data-v-2582585f${_scopeId}></div>`);
            } else {
              _push2(`<!---->`);
            }
            if (showImportModal.value) {
              _push2(`<div class="modal fade show d-block" tabindex="-1" data-v-2582585f${_scopeId}><div class="modal-dialog modal-dialog-centered" data-v-2582585f${_scopeId}><div class="modal-content" data-v-2582585f${_scopeId}><div class="modal-header" data-v-2582585f${_scopeId}><h5 class="modal-title" data-v-2582585f${_scopeId}><i class="fas fa-file-import me-2" data-v-2582585f${_scopeId}></i> Import Sifat Benda </h5><button type="button" class="btn-close" data-v-2582585f${_scopeId}></button></div><div class="modal-body" data-v-2582585f${_scopeId}><div class="alert alert-info mb-3" data-v-2582585f${_scopeId}><i class="fas fa-info-circle me-1" data-v-2582585f${_scopeId}></i> Download template terlebih dahulu, isi data sesuai format, lalu upload file yang sudah diisi. </div><div class="mb-3" data-v-2582585f${_scopeId}><a${ssrRenderAttr("href", _ctx.route("property-items.import-template"))} class="btn btn-outline-primary" data-v-2582585f${_scopeId}><i class="fas fa-download me-1" data-v-2582585f${_scopeId}></i> Download Template </a></div><div class="mb-3" data-v-2582585f${_scopeId}><label class="form-label fw-medium" data-v-2582585f${_scopeId}>File Excel</label><input type="file" class="${ssrRenderClass([{ "is-invalid": unref(importForm).errors.file }, "form-control"])}" accept=".xlsx,.xls" data-v-2582585f${_scopeId}>`);
              if (unref(importForm).errors.file) {
                _push2(`<div class="invalid-feedback" data-v-2582585f${_scopeId}>${ssrInterpolate(unref(importForm).errors.file)}</div>`);
              } else {
                _push2(`<!---->`);
              }
              _push2(`</div></div><div class="modal-footer" data-v-2582585f${_scopeId}><button type="button" class="btn btn-secondary" data-v-2582585f${_scopeId}>Batal</button><button type="button" class="btn btn-success"${ssrIncludeBooleanAttr(unref(importForm).processing || !unref(importForm).file) ? " disabled" : ""} data-v-2582585f${_scopeId}>`);
              if (unref(importForm).processing) {
                _push2(`<span class="spinner-border spinner-border-sm me-1" data-v-2582585f${_scopeId}></span>`);
              } else {
                _push2(`<i class="fas fa-upload me-1" data-v-2582585f${_scopeId}></i>`);
              }
                  ...
                  createVNode("div", { class: "modal-content" }, [
                    createVNode("div", { class: "modal-header" }, [
                      createVNode("h5", { class: "modal-title" }, [
                        ...
                        createTextVNode(" Import Sifat Benda ")
                      ]),
                      createVNode("button", {
                        type: "button",
                        class: "btn-close",
                    ...
                    createVNode("div", { class: "modal-body" }, [
                      ...
                      createVNode("div", { class: "mb-3" }, [
                        createVNode("a", {
                          href: _ctx.route("property-items.import-template"),
...
const Index = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-2582585f"]]);
export {
  Index as default
};
