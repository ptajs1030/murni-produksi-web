    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(_sfc_main$1, { title: "Daftar Supplier" }, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div class="overflow-hidden bg-white shadow-sm sm:rounded-lg" data-v-d9adc3fd${_scopeId}><div class="p-3 text-gray-900" data-v-d9adc3fd${_scopeId}><div class="d-flex justify-content-between align-items-center mb-3" data-v-d9adc3fd${_scopeId}><div class="d-flex align-items-center gap-3" data-v-d9adc3fd${_scopeId}>`);
            ...
            if (hasActiveFilters.value) {
              _push2(`<button class="btn btn-outline-secondary" data-v-d9adc3fd${_scopeId}><i class="fas fa-times me-1" data-v-d9adc3fd${_scopeId}></i> Clear </button>`);
            } else {
              _push2(`<!---->`);
            }
            _push2(`</div><div class="d-flex gap-2" data-v-d9adc3fd${_scopeId}><button class="btn btn-primary" data-v-d9adc3fd${_scopeId}><i class="fas fa-plus me-1" data-v-d9adc3fd${_scopeId}></i> Tambah Supplier </button><button class="btn btn-success" data-v-d9adc3fd${_scopeId}> Export Excel </button></div></div></div></div><div class="card" data-v-d9adc3fd${_scopeId}><div class="table-responsive" data-v-d9adc3fd${_scopeId}><table class="table-hover mb-0 table" data-v-d9adc3fd${_scopeId}><thead class="table-light" data-v-d9adc3fd${_scopeId}><tr data-v-d9adc3fd${_scopeId}><th class="text-center" style="${ssrRenderStyle({ "width": "60px" })}" data-v-d9adc3fd${_scopeId}>#</th><th class="${ssrRenderClass({
              sortable: isSortable("supplier_code")
            })}" style="${ssrRenderStyle({ "cursor": "pointer" })}" data-v-d9adc3fd${_scopeId}> Kode Supplier `);
            if (isSortable("supplier_code")) {
              _push2(`<i class="${ssrRenderClass([getSortIcon("supplier_code"), "ms-1"])}" data-v-d9adc3fd${_scopeId}></i>`);
            } else {
              _push2(`<!---->`);
            }
            _push2(`</th><th class="${ssrRenderClass({
              sortable: isSortable("supplier_name")
            })}" style="${ssrRenderStyle({ "cursor": "pointer" })}" data-v-d9adc3fd${_scopeId}> Nama Supplier `);
            if (isSortable("supplier_name")) {
              _push2(`<i class="${ssrRenderClass([getSortIcon("supplier_name"), "ms-1"])}" data-v-d9adc3fd${_scopeId}></i>`);
            } else {
              _push2(`<!---->`);
            }
            _push2(`</th><th class="${ssrRenderClass({ sortable: isSortable("created_at") })}" style="${ssrRenderStyle({ "cursor": "pointer" })}" data-v-d9adc3fd${_scopeId}> Tanggal Dibuat `);
            if (isSortable("created_at")) {
              _push2(`<i class="${ssrRenderClass([getSortIcon("created_at"), "ms-1"])}" data-v-d9adc3fd${_scopeId}></i>`);
            } else {
              _push2(`<!---->`);
            }
            _push2(`</th><th class="text-center" style="${ssrRenderStyle({ "width": "120px" })}" data-v-d9adc3fd${_scopeId}> Aksi </th></tr></thead><tbody data-v-d9adc3fd${_scopeId}>`);
            if (__props.suppliers.data && __props.suppliers.data.length === 0) {
              _push2(`<tr data-v-d9adc3fd${_scopeId}><td colspan="5" class="text-muted py-4 text-center" data-v-d9adc3fd${_scopeId}><i class="fas fa-inbox fa-2x d-block mb-2" data-v-d9adc3fd${_scopeId}></i>`);
              if (search.value) {
                _push2(`<div data-v-d9adc3fd${_scopeId}> Tidak ada data yang sesuai dengan pencarian &quot;${ssrInterpolate(search.value)}&quot; </div>`);
              } else {
                _push2(`<div data-v-d9adc3fd${_scopeId}>Belum ada data supplier</div>`);
              }
              _push2(`</td></tr>`);
            } else {
              _push2(`<!--[-->`);
              ssrRenderList(__props.suppliers.data, (supplier, index) => {
                _push2(`<tr data-v-d9adc3fd${_scopeId}><td class="text-muted text-center" data-v-d9adc3fd${_scopeId}>${ssrInterpolate(__props.suppliers.from + index)}</td><td data-v-d9adc3fd${_scopeId}><span class="badge bg-secondary" data-v-d9adc3fd${_scopeId}>${ssrInterpolate(supplier.supplier_code)}</span></td><td class="fw-medium" data-v-d9adc3fd${_scopeId}>${ssrInterpolate(supplier.supplier_name)}</td><td class="text-muted" data-v-d9adc3fd${_scopeId}>${ssrInterpolate(new Date(
                  supplier.created_at
                ).toLocaleDateString("id-ID", {
                  year: "numeric",
                  month: "short",
                  day: "numeric"
                }))}</td><td class="text-center" data-v-d9adc3fd${_scopeId}><div class="btn-group btn-group-md" role="group" data-v-d9adc3fd${_scopeId}><button class="btn btn-outline-warning" title="Edit Supplier" data-v-d9adc3fd${_scopeId}><i class="fas fa-edit" data-v-d9adc3fd${_scopeId}></i></button><button class="btn btn-outline-danger" title="Hapus Supplier" data-v-d9adc3fd${_scopeId}><i class="fas fa-trash" data-v-d9adc3fd${_scopeId}></i></button></div></td></tr>`);
              });
              _push2(`<!--]-->`);
            }
            _push2(`</tbody></table></div></div><div class="mt-3" data-v-d9adc3fd${_scopeId}>`);
...
const Index = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-d9adc3fd"]]);
export {
  Index as default
};
