    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(_sfc_main$1, { title: "Daftar Kategori" }, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div class="overflow-hidden bg-white shadow-sm sm:rounded-lg" data-v-a4e9aaeb${_scopeId}><div class="p-3 text-gray-900" data-v-a4e9aaeb${_scopeId}><div class="d-flex justify-content-between align-items-center mb-3" data-v-a4e9aaeb${_scopeId}><div class="d-flex align-items-center gap-3" data-v-a4e9aaeb${_scopeId}>`);
            ...
            if (hasActiveFilters.value) {
              _push2(`<button class="btn btn-outline-secondary" data-v-a4e9aaeb${_scopeId}><i class="fas fa-times me-1" data-v-a4e9aaeb${_scopeId}></i> Clear </button>`);
            } else {
              _push2(`<!---->`);
            }
            _push2(`</div><div class="d-flex gap-2" data-v-a4e9aaeb${_scopeId}><button class="btn btn-primary" data-v-a4e9aaeb${_scopeId}><i class="fas fa-plus me-1" data-v-a4e9aaeb${_scopeId}></i> Tambah Kategori </button><button class="btn btn-success" data-v-a4e9aaeb${_scopeId}> Export Excel </button></div></div></div></div><div class="card" data-v-a4e9aaeb${_scopeId}><div class="table-responsive" data-v-a4e9aaeb${_scopeId}><table class="table-hover mb-0 table" data-v-a4e9aaeb${_scopeId}><thead class="table-light" data-v-a4e9aaeb${_scopeId}><tr data-v-a4e9aaeb${_scopeId}><th class="text-center" style="${ssrRenderStyle({ "width": "60px" })}" data-v-a4e9aaeb${_scopeId}>#</th><th class="${ssrRenderClass({
              sortable: isSortable("category_code")
            })}" style="${ssrRenderStyle({ "cursor": "pointer" })}" data-v-a4e9aaeb${_scopeId}> Kode Kategori `);
            if (isSortable("category_code")) {
              _push2(`<i class="${ssrRenderClass([getSortIcon("category_code"), "ms-1"])}" data-v-a4e9aaeb${_scopeId}></i>`);
            } else {
              _push2(`<!---->`);
            }
            _push2(`</th><th class="${ssrRenderClass({
              sortable: isSortable("category_name")
            })}" style="${ssrRenderStyle({ "cursor": "pointer" })}" data-v-a4e9aaeb${_scopeId}> Nama Kategori `);
            if (isSortable("category_name")) {
              _push2(`<i class="${ssrRenderClass([getSortIcon("category_name"), "ms-1"])}" data-v-a4e9aaeb${_scopeId}></i>`);
            } else {
              _push2(`<!---->`);
            }
            _push2(`</th><th class="${ssrRenderClass({ sortable: isSortable("created_at") })}" style="${ssrRenderStyle({ "cursor": "pointer" })}" data-v-a4e9aaeb${_scopeId}> Tanggal Dibuat `);
            if (isSortable("created_at")) {
              _push2(`<i class="${ssrRenderClass([getSortIcon("created_at"), "ms-1"])}" data-v-a4e9aaeb${_scopeId}></i>`);
            } else {
              _push2(`<!---->`);
            }
            _push2(`</th><th class="text-center" style="${ssrRenderStyle({ "width": "120px" })}" data-v-a4e9aaeb${_scopeId}> Aksi </th></tr></thead><tbody data-v-a4e9aaeb${_scopeId}>`);
            if (__props.categories.data && __props.categories.data.length === 0) {
              _push2(`<tr data-v-a4e9aaeb${_scopeId}><td colspan="5" class="text-muted py-4 text-center" data-v-a4e9aaeb${_scopeId}><i class="fas fa-inbox fa-2x d-block mb-2" data-v-a4e9aaeb${_scopeId}></i>`);
              if (search.value) {
                _push2(`<div data-v-a4e9aaeb${_scopeId}> Tidak ada data yang sesuai dengan pencarian &quot;${ssrInterpolate(search.value)}&quot; </div>`);
              } else {
                _push2(`<div data-v-a4e9aaeb${_scopeId}>Belum ada data kategori</div>`);
              }
              _push2(`</td></tr>`);
            } else {
              _push2(`<!--[-->`);
              ssrRenderList(__props.categories.data, (category, index) => {
                _push2(`<tr data-v-a4e9aaeb${_scopeId}><td class="text-muted text-center" data-v-a4e9aaeb${_scopeId}>${ssrInterpolate(__props.categories.from + index)}</td><td data-v-a4e9aaeb${_scopeId}><span class="badge bg-secondary" data-v-a4e9aaeb${_scopeId}>${ssrInterpolate(category.category_code)}</span></td><td class="fw-medium" data-v-a4e9aaeb${_scopeId}>${ssrInterpolate(category.category_name)}</td><td class="text-muted" data-v-a4e9aaeb${_scopeId}>${ssrInterpolate(new Date(
                  category.created_at
                ).toLocaleDateString("id-ID", {
                  year: "numeric",
                  month: "short",
                  day: "numeric"
                }))}</td><td class="text-center" data-v-a4e9aaeb${_scopeId}><div class="btn-group btn-group-md" role="group" data-v-a4e9aaeb${_scopeId}><button class="btn btn-outline-warning" title="Edit Kategori" data-v-a4e9aaeb${_scopeId}><i class="fas fa-edit" data-v-a4e9aaeb${_scopeId}></i></button><button class="btn btn-outline-danger" title="Hapus Kategori" data-v-a4e9aaeb${_scopeId}><i class="fas fa-trash" data-v-a4e9aaeb${_scopeId}></i></button></div></td></tr>`);
              });
              _push2(`<!--]-->`);
            }
            _push2(`</tbody></table></div></div><div class="mt-3" data-v-a4e9aaeb${_scopeId}>`);
...
const Index = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-a4e9aaeb"]]);
export {
  Index as default
};
