    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(_sfc_main$1, { title: "Daftar Product Level" }, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div class="overflow-hidden bg-white shadow-sm sm:rounded-lg" data-v-0627dd3f${_scopeId}><div class="p-3 text-gray-900" data-v-0627dd3f${_scopeId}><div class="d-flex justify-content-between align-items-center mb-3" data-v-0627dd3f${_scopeId}><div class="d-flex align-items-center gap-3" data-v-0627dd3f${_scopeId}>`);
            ...
            if (hasActiveFilters.value) {
              _push2(`<button class="btn btn-outline-secondary" data-v-0627dd3f${_scopeId}><i class="fas fa-times me-1" data-v-0627dd3f${_scopeId}></i> Clear </button>`);
            } else {
              _push2(`<!---->`);
            }
            _push2(`</div><button class="btn btn-primary" data-v-0627dd3f${_scopeId}><i class="fas fa-plus me-1" data-v-0627dd3f${_scopeId}></i> Tambah Product Level </button></div></div></div><div class="card" data-v-0627dd3f${_scopeId}><div class="table-responsive" data-v-0627dd3f${_scopeId}><table class="table-hover mb-0 table" data-v-0627dd3f${_scopeId}><thead class="table-light" data-v-0627dd3f${_scopeId}><tr data-v-0627dd3f${_scopeId}><th class="text-center" style="${ssrRenderStyle({ "width": "60px" })}" data-v-0627dd3f${_scopeId}>#</th><th class="${ssrRenderClass({
              sortable: isSortable("level_code")
            })}" style="${ssrRenderStyle({ "cursor": "pointer" })}" data-v-0627dd3f${_scopeId}> Level Code `);
            if (isSortable("level_code")) {
              _push2(`<i class="${ssrRenderClass([getSortIcon("level_code"), "ms-1"])}" data-v-0627dd3f${_scopeId}></i>`);
            } else {
              _push2(`<!---->`);
            }
            _push2(`</th><th class="${ssrRenderClass({
              sortable: isSortable("level_description")
            })}" style="${ssrRenderStyle({ "cursor": "pointer" })}" data-v-0627dd3f${_scopeId}> Description `);
            if (isSortable("level_description")) {
              _push2(`<i class="${ssrRenderClass([getSortIcon("level_description"), "ms-1"])}" data-v-0627dd3f${_scopeId}></i>`);
            } else {
              _push2(`<!---->`);
            }
            _push2(`</th><th class="${ssrRenderClass({ sortable: isSortable("created_at") })}" style="${ssrRenderStyle({ "cursor": "pointer" })}" data-v-0627dd3f${_scopeId}> Tanggal Dibuat `);
            if (isSortable("created_at")) {
              _push2(`<i class="${ssrRenderClass([getSortIcon("created_at"), "ms-1"])}" data-v-0627dd3f${_scopeId}></i>`);
            } else {
              _push2(`<!---->`);
            }
            _push2(`</th><th class="text-center" style="${ssrRenderStyle({ "width": "120px" })}" data-v-0627dd3f${_scopeId}> Aksi </th></tr></thead><tbody data-v-0627dd3f${_scopeId}>`);
            if (__props.productLevels.data && __props.productLevels.data.length === 0) {
              _push2(`<tr data-v-0627dd3f${_scopeId}><td colspan="5" class="text-muted py-4 text-center" data-v-0627dd3f${_scopeId}><i class="fas fa-inbox fa-2x d-block mb-2" data-v-0627dd3f${_scopeId}></i>`);
              if (search.value) {
                _push2(`<div data-v-0627dd3f${_scopeId}> Tidak ada data yang sesuai dengan pencarian &quot;${ssrInterpolate(search.value)}&quot; </div>`);
              } else {
                _push2(`<div data-v-0627dd3f${_scopeId}>Belum ada data product level</div>`);
              }
              _push2(`</td></tr>`);
            } else {
              _push2(`<!--[-->`);
              ssrRenderList(__props.productLevels.data, (productLevel, index) => {
                _push2(`<tr data-v-0627dd3f${_scopeId}><td class="text-muted text-center" data-v-0627dd3f${_scopeId}>${ssrInterpolate(__props.productLevels.from + index)}</td><td class="fw-medium" data-v-0627dd3f${_scopeId}>${ssrInterpolate(productLevel.level_code)}</td><td class="fw-medium" data-v-0627dd3f${_scopeId}>${ssrInterpolate(productLevel.level_description)}</td><td class="text-muted" data-v-0627dd3f${_scopeId}>${ssrInterpolate(new Date(
                  productLevel.created_at
                ).toLocaleDateString("id-ID", {
                  year: "numeric",
                  month: "short",
                  day: "numeric"
                }))}</td><td class="text-center" data-v-0627dd3f${_scopeId}><div class="btn-group btn-group-md" role="group" data-v-0627dd3f${_scopeId}><button class="btn btn-outline-warning" title="Edit Product Level" data-v-0627dd3f${_scopeId}><i class="fas fa-edit" data-v-0627dd3f${_scopeId}></i></button><button class="btn btn-outline-danger" title="Hapus Product Level" data-v-0627dd3f${_scopeId}><i class="fas fa-trash" data-v-0627dd3f${_scopeId}></i></button></div></td></tr>`);
              });
              _push2(`<!--]-->`);
            }
            _push2(`</tbody></table></div></div><div class="mt-3" data-v-0627dd3f${_scopeId}>`);
...
const Index = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-0627dd3f"]]);
export {
  Index as default
};
