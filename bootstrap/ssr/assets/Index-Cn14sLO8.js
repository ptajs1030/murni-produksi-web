...
import _sfc_main$4 from "./IncomingProductModal-DPgsMi86.js";
...
import "./ProductSearchInput-CO810yGG.js";
const _sfc_main = {
  __name: "Index",
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(_sfc_main$1, { title: "Barang Datang" }, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          ...
          if (_push2) {
            _push2(`<div class="overflow-hidden bg-white shadow-sm sm:rounded-lg" data-v-f2fa5599${_scopeId}><div class="p-3 text-gray-900" data-v-f2fa5599${_scopeId}><div class="d-flex justify-content-between align-items-center mb-3" data-v-f2fa5599${_scopeId}><div class="d-flex align-items-center gap-3" data-v-f2fa5599${_scopeId}>`);
            ...
            if (hasActiveFilters.value) {
              _push2(`<button type="button" class="btn btn-outline-secondary" data-v-f2fa5599${_scopeId}><i class="fas fa-times me-1" data-v-f2fa5599${_scopeId}></i> Clear </button>`);
            } else {
              _push2(`<!---->`);
            }
            _push2(`</div><button type="button" class="btn btn-primary" data-v-f2fa5599${_scopeId}><i class="fas fa-plus me-1" data-v-f2fa5599${_scopeId}></i> Tambah Barang Datang </button></div></div></div><div class="card" data-v-f2fa5599${_scopeId}><div class="table-responsive" data-v-f2fa5599${_scopeId}><table class="table table-hover mb-0" data-v-f2fa5599${_scopeId}><thead class="table-light" data-v-f2fa5599${_scopeId}><tr data-v-f2fa5599${_scopeId}><th class="text-center" style="${ssrRenderStyle({ "width": "60px" })}" data-v-f2fa5599${_scopeId}>No</th><th data-v-f2fa5599${_scopeId}>Nama Produk</th><th class="text-center" style="${ssrRenderStyle({ "width": "100px" })}" data-v-f2fa5599${_scopeId}> Qty </th><th class="text-center" style="${ssrRenderStyle({ "width": "140px" })}" data-v-f2fa5599${_scopeId}> Harga </th><th style="${ssrRenderStyle({ "width": "160px" })}" data-v-f2fa5599${_scopeId}>Tanggal Masuk</th><th class="text-center" style="${ssrRenderStyle({ "width": "110px" })}" data-v-f2fa5599${_scopeId}> Status </th>`);
            if (isOwner.value) {
              _push2(`<th class="text-center" style="${ssrRenderStyle({ "width": "200px" })}" data-v-f2fa5599${_scopeId}> Aksi </th>`);
            } else {
              _push2(`<!---->`);
            }
            _push2(`</tr></thead><tbody data-v-f2fa5599${_scopeId}>`);
            if (!((_b = (_a2 = __props.incoming) == null ? void 0 : _a2.data) == null ? void 0 : _b.length)) {
              _push2(`<tr data-v-f2fa5599${_scopeId}><td${ssrRenderAttr("colspan", isOwner.value ? 7 : 6)} class="text-muted py-4 text-center" data-v-f2fa5599${_scopeId}><i class="fas fa-inbox fa-2x d-block mb-2" data-v-f2fa5599${_scopeId}></i>`);
              if (search.value) {
                _push2(`<div data-v-f2fa5599${_scopeId}> Tidak ada data yang sesuai dengan pencarian &quot;${ssrInterpolate(search.value)}&quot; </div>`);
              } else {
                _push2(`<div data-v-f2fa5599${_scopeId}>Belum ada data barang datang</div>`);
              }
              _push2(`</td></tr>`);
            } else {
              _push2(`<!--[-->`);
              ssrRenderList(__props.incoming.data, (row, index) => {
                var _a3;
                _push2(`<tr data-v-f2fa5599${_scopeId}><td class="text-muted text-center" data-v-f2fa5599${_scopeId}>${ssrInterpolate((__props.incoming.from ?? 0) + index)}</td><td class="fw-medium" data-v-f2fa5599${_scopeId}>${ssrInterpolate(((_a3 = row.product) == null ? void 0 : _a3.product_name) ?? "-")}</td><td class="text-center" data-v-f2fa5599${_scopeId}><span class="badge bg-light text-dark border" data-v-f2fa5599${_scopeId}>${ssrInterpolate(row.packaging_size_input)}</span></td><td class="text-center" data-v-f2fa5599${_scopeId}>${ssrInterpolate(formatCurrency(row.price))}</td><td class="text-muted small" data-v-f2fa5599${_scopeId}>${ssrInterpolate(formatDate(row.created_at))}</td><td class="text-center" data-v-f2fa5599${_scopeId}><span class="${ssrRenderClass([statusBadgeClass(row.status), "badge"])}" data-v-f2fa5599${_scopeId}><i class="${ssrRenderClass([{
                  "fa-clock": row.status === "PENDING",
                  "fa-check-circle": row.status === "APPROVED",
                  "fa-times-circle": row.status === "REJECTED"
                }, "fas me-1"])}" data-v-f2fa5599${_scopeId}></i> ${ssrInterpolate(row.status)}</span></td>`);
                if (isOwner.value) {
                  _push2(`<td class="text-center" data-v-f2fa5599${_scopeId}>`);
                  if (row.status === "PENDING") {
                    _push2(`<div class="d-flex gap-1 justify-content-center" data-v-f2fa5599${_scopeId}><button type="button" class="btn btn-success btn-sm" data-v-f2fa5599${_scopeId}><i class="fas fa-check me-1" data-v-f2fa5599${_scopeId}></i> Setujui </button><button type="button" class="btn btn-outline-danger btn-sm" data-v-f2fa5599${_scopeId}><i class="fas fa-times me-1" data-v-f2fa5599${_scopeId}></i> Tolak </button></div>`);
                  } else {
                    _push2(`<span class="text-muted small" data-v-f2fa5599${_scopeId}><i class="fas fa-check-double me-1" data-v-f2fa5599${_scopeId}></i> Selesai </span>`);
                  }
                  _push2(`</td>`);
                } else {
                  _push2(`<!---->`);
            ...
            _push2(`</tbody></table></div></div><div class="mt-3" data-v-f2fa5599${_scopeId}>`);
            _push2(ssrRenderComponent(_sfc_main$3, {
              links: ((_c = __props.incoming) == null ? void 0 : _c.links) ?? []
            }, null, _parent2, _scopeId));
            _push2(`</div>`);
                ...
                createVNode("div", { class: "table-responsive" }, [
                  createVNode("table", { class: "table table-hover mb-0" }, [
                    ...
                    createVNode("tbody", null, [
                      !((_e = (_d = __props.incoming) == null ? void 0 : _d.data) == null ? void 0 : _e.length) ? (openBlock(), createBlock("tr", { key: 0 }, [
                        createVNode("td", {
...
const Index = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-f2fa5599"]]);
export {
  Index as default
};
