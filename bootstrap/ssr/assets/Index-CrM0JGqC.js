    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(_sfc_main$1, { title: "Stock Opnames" }, {
        header: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<h2 class="text-xl font-semibold leading-tight text-gray-800" data-v-4fe06805${_scopeId}> Stock Opnames </h2>`);
          } else {
            return [
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div class="overflow-hidden bg-white shadow-sm sm:rounded-lg" data-v-4fe06805${_scopeId}><div class="p-3 text-gray-900" data-v-4fe06805${_scopeId}><div class="d-flex justify-content-between align-items-center mb-3" data-v-4fe06805${_scopeId}><div class="d-flex align-items-center gap-3" data-v-4fe06805${_scopeId}><input${ssrRenderAttr("value", startDate.value)} type="date" class="form-control" style="${ssrRenderStyle({ "width": "150px" })}" data-v-4fe06805${_scopeId}><input${ssrRenderAttr("value", endDate.value)} type="date" class="form-control" style="${ssrRenderStyle({ "width": "150px" })}" data-v-4fe06805${_scopeId}></div><button class="btn btn-primary" data-v-4fe06805${_scopeId}><i class="fas fa-plus me-1" data-v-4fe06805${_scopeId}></i> Buat Stock Opname </button></div><div class="table-responsive" data-v-4fe06805${_scopeId}><table class="table-bordered table-striped table" data-v-4fe06805${_scopeId}><thead class="table-light" data-v-4fe06805${_scopeId}><tr data-v-4fe06805${_scopeId}><th data-v-4fe06805${_scopeId}>No.</th><th data-v-4fe06805${_scopeId}>Date</th><th data-v-4fe06805${_scopeId}>Total Request</th><th data-v-4fe06805${_scopeId}>Products Count</th><th data-v-4fe06805${_scopeId}>Actions</th></tr></thead><tbody data-v-4fe06805${_scopeId}><!--[-->`);
            ssrRenderList(__props.stockOpnames.data, (stockOpname, index) => {
              var _a;
              _push2(`<tr data-v-4fe06805${_scopeId}><td data-v-4fe06805${_scopeId}>${ssrInterpolate(getRowNumber(index))}</td><td data-v-4fe06805${_scopeId}>${ssrInterpolate(formatDate(stockOpname.date_request))}</td><td data-v-4fe06805${_scopeId}>${ssrInterpolate(stockOpname.total_request || "-")}</td><td data-v-4fe06805${_scopeId}><span class="badge bg-info" data-v-4fe06805${_scopeId}>${ssrInterpolate(((_a = stockOpname.stock_opname_products) == null ? void 0 : _a.length) || 0)} items </span></td><td data-v-4fe06805${_scopeId}><div class="btn-group" data-v-4fe06805${_scopeId}>`);
              _push2(ssrRenderComponent(unref(Link), {
                ...
                default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                  if (_push3) {
                    _push3(`<i class="fas fa-eye" data-v-4fe06805${_scopeId2}></i>`);
                  } else {
                    return [
            ...
            if (__props.stockOpnames.data.length === 0) {
              _push2(`<div class="py-4 text-center" data-v-4fe06805${_scopeId}><p class="text-muted" data-v-4fe06805${_scopeId}>No stock opnames found.</p></div>`);
            } else {
              _push2(`<!---->`);
            }
...
const Index = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-4fe06805"]]);
export {
  Index as default
};
