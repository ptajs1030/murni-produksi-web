...
import RepackModal from "./RepackModal-cJOt2sMw.js";
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(_sfc_main$1, { title: "Repack Produk" }, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div class="overflow-hidden bg-white shadow-sm sm:rounded-lg" data-v-4d8ed303${_scopeId}><div class="p-3 text-gray-900" data-v-4d8ed303${_scopeId}><div class="d-flex justify-content-between align-items-center mb-3" data-v-4d8ed303${_scopeId}><div class="d-flex align-items-center gap-3" data-v-4d8ed303${_scopeId}>`);
            ...
            if (__props.products.data.length > 0) {
              _push2(`<div class="table-responsive" data-v-4d8ed303${_scopeId}><table class="table-bordered table-striped table" data-v-4d8ed303${_scopeId}><thead class="table-light" data-v-4d8ed303${_scopeId}><tr data-v-4d8ed303${_scopeId}><th data-v-4d8ed303${_scopeId}>No.</th><th data-v-4d8ed303${_scopeId}>SKU</th><th data-v-4d8ed303${_scopeId}>Nama Produk</th><th data-v-4d8ed303${_scopeId}>Stock</th><th data-v-4d8ed303${_scopeId}>Actions</th></tr></thead><tbody data-v-4d8ed303${_scopeId}><!--[-->`);
              ssrRenderList(__props.products.data, (product, index) => {
                _push2(`<tr data-v-4d8ed303${_scopeId}><td data-v-4d8ed303${_scopeId}>${ssrInterpolate(getRowNumber(index))}</td><td data-v-4d8ed303${_scopeId}>${ssrInterpolate(product.product_unit_sku)}</td><td data-v-4d8ed303${_scopeId}>${ssrInterpolate(product.product_name)}</td><td data-v-4d8ed303${_scopeId}>${ssrInterpolate(unref(formatNumberWithCommas)(
                  getStock(product)
                ))}</td><td data-v-4d8ed303${_scopeId}><button class="btn btn-primary btn-sm"${ssrIncludeBooleanAttr(getStock(product) <= 0) ? " disabled" : ""} title="Repack" data-v-4d8ed303${_scopeId}><i class="fas fa-box-open me-1" data-v-4d8ed303${_scopeId}></i> Repack </button></td></tr>`);
              });
            ...
            if (__props.products.data.length === 0) {
              _push2(`<div class="py-4 text-center" data-v-4d8ed303${_scopeId}><p class="text-muted" data-v-4d8ed303${_scopeId}>Tidak ada produk ditemukan.</p></div>`);
            } else {
              _push2(`<!---->`);
            }
...
const Index = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-4d8ed303"]]);
export {
  Index as default
};
