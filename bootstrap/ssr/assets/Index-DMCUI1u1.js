    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(_sfc_main$1, { title: "Daftar Resep" }, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div class="overflow-hidden bg-white shadow-sm sm:rounded-lg" data-v-576f0257${_scopeId}><div class="p-3 text-gray-900" data-v-576f0257${_scopeId}><div class="d-flex justify-content-between align-items-center mb-3" data-v-576f0257${_scopeId}><div class="d-flex align-items-center gap-3" data-v-576f0257${_scopeId}>`);
            ...
            if (hasActiveFilters.value) {
              _push2(`<button class="btn btn-outline-secondary" data-v-576f0257${_scopeId}><i class="fas fa-times me-1" data-v-576f0257${_scopeId}></i> Clear </button>`);
            } else {
              _push2(`<!---->`);
            }
            _push2(`</div><button class="btn btn-primary" data-v-576f0257${_scopeId}><i class="fas fa-plus me-1" data-v-576f0257${_scopeId}></i> Tambah Resep </button></div></div></div><div class="card" data-v-576f0257${_scopeId}><div class="table-responsive" data-v-576f0257${_scopeId}><table class="table-hover mb-0 table" data-v-576f0257${_scopeId}><thead class="table-light" data-v-576f0257${_scopeId}><tr data-v-576f0257${_scopeId}><th class="text-center" style="${ssrRenderStyle({ "width": "60px" })}" data-v-576f0257${_scopeId}>#</th><th class="${ssrRenderClass({
              sortable: isSortable("product_name")
            })}" style="${ssrRenderStyle({ "cursor": "pointer" })}" data-v-576f0257${_scopeId}> Nama Produk `);
            if (isSortable("product_name")) {
              _push2(`<i class="${ssrRenderClass([getSortIcon("product_name"), "ms-1"])}" data-v-576f0257${_scopeId}></i>`);
            } else {
              _push2(`<!---->`);
            }
            _push2(`</th><th class="text-center" style="${ssrRenderStyle({ "width": "140px" })}" data-v-576f0257${_scopeId}> Aksi </th></tr></thead><tbody data-v-576f0257${_scopeId}>`);
            if (__props.recipes.data && __props.recipes.data.length === 0) {
              _push2(`<tr data-v-576f0257${_scopeId}><td colspan="5" class="text-muted py-4 text-center" data-v-576f0257${_scopeId}><i class="fas fa-inbox fa-2x d-block mb-2" data-v-576f0257${_scopeId}></i>`);
              if (search.value) {
                _push2(`<div data-v-576f0257${_scopeId}> Tidak ada data yang sesuai dengan pencarian &quot;${ssrInterpolate(search.value)}&quot; </div>`);
              } else {
                _push2(`<div data-v-576f0257${_scopeId}>Belum ada data resep</div>`);
              }
              _push2(`</td></tr>`);
            } else {
              _push2(`<!--[-->`);
              ssrRenderList(__props.recipes.data, (recipe, index) => {
                var _a;
                _push2(`<tr data-v-576f0257${_scopeId}><td class="text-muted text-center" data-v-576f0257${_scopeId}>${ssrInterpolate(__props.recipes.from + index)}</td><td class="fw-medium" data-v-576f0257${_scopeId}>${ssrInterpolate((_a = recipe.product) == null ? void 0 : _a.product_name)}</td><td class="text-center" data-v-576f0257${_scopeId}><div class="btn-group btn-group-sm" role="group" data-v-576f0257${_scopeId}><button class="btn btn-outline-warning" title="Edit Resep" data-v-576f0257${_scopeId}><i class="fas fa-edit" data-v-576f0257${_scopeId}></i></button><button class="btn btn-outline-danger" title="Hapus Resep" data-v-576f0257${_scopeId}><i class="fas fa-trash" data-v-576f0257${_scopeId}></i></button></div></td></tr>`);
              });
              _push2(`<!--]-->`);
            }
            _push2(`</tbody></table></div></div><div class="mt-3" data-v-576f0257${_scopeId}>`);
...
const Index = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-576f0257"]]);
export {
  Index as default
};
