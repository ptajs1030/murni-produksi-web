...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    const exportExcel = () => {
      ...
      const url = route("stock-opnames.products.export", props.stockOpname.id) + (queryString ? "?" + queryString : "");
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(_sfc_main$1, { title: "Stock Opname Products" }, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div class="overflow-hidden bg-white shadow-sm sm:rounded-lg" data-v-9debc47d${_scopeId}><div class="p-3 text-gray-900" data-v-9debc47d${_scopeId}><div class="${ssrRenderClass([isSubmitted.value ? "alert-success" : "alert-info", "alert mb-3"])}" data-v-9debc47d${_scopeId}><div class="d-flex justify-content-between align-items-center" data-v-9debc47d${_scopeId}><div data-v-9debc47d${_scopeId}><strong data-v-9debc47d${_scopeId}>Stock Opname:</strong> #${ssrInterpolate(__props.stockOpname.id)} | <strong data-v-9debc47d${_scopeId}>Tanggal:</strong> ${ssrInterpolate(formatDate(__props.stockOpname.date_request))} | <strong data-v-9debc47d${_scopeId}>Status:</strong><span class="${ssrRenderClass(
              isSubmitted.value ? "badge bg-success" : "badge bg-warning text-dark"
            )}" data-v-9debc47d${_scopeId}>${ssrInterpolate(isSubmitted.value ? "Submitted" : "Draft")}</span></div></div></div><div class="d-flex justify-content-between align-items-center mb-3" data-v-9debc47d${_scopeId}><div class="d-flex align-items-center gap-3" data-v-9debc47d${_scopeId}>`);
            ...
            _push2(`</div><div class="d-flex gap-2" data-v-9debc47d${_scopeId}>`);
            if (!isSubmitted.value) {
              _push2(`<button class="btn btn-primary" data-v-9debc47d${_scopeId}><i class="fas fa-plus me-1" data-v-9debc47d${_scopeId}></i> Tambah Product </button>`);
            } else {
              _push2(`<!---->`);
            }
            _push2(`<button class="btn btn-success" data-v-9debc47d${_scopeId}><i class="fas fa-file-excel me-2" data-v-9debc47d${_scopeId}></i> Export Excel </button>`);
            _push2(ssrRenderComponent(unref(Link), {
              ...
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<i class="fas fa-arrow-left me-2" data-v-9debc47d${_scopeId2}></i> Back to Stock Opnames `);
                } else {
                  return [
            ...
            if (__props.stockOpnameProducts.data.length > 0) {
              _push2(`<div class="table-responsive" data-v-9debc47d${_scopeId}><table class="table-bordered table-striped table" data-v-9debc47d${_scopeId}><thead class="table-light" data-v-9debc47d${_scopeId}><tr data-v-9debc47d${_scopeId}><th data-v-9debc47d${_scopeId}>No.</th><th data-v-9debc47d${_scopeId}>Product SKU</th><th data-v-9debc47d${_scopeId}>Product Name</th>`);
              if (isOwner.value) {
                _push2(`<th data-v-9debc47d${_scopeId}>Stock System</th>`);
              } else {
                _push2(`<!---->`);
              }
              _push2(`<th data-v-9debc47d${_scopeId}>Real Quantity</th><th data-v-9debc47d${_scopeId}>Expired Quantity</th>`);
              if (isOwner.value) {
                _push2(`<th data-v-9debc47d${_scopeId}>Selisih</th>`);
              } else {
                _push2(`<!---->`);
              }
              _push2(`<th data-v-9debc47d${_scopeId}>Status</th><th data-v-9debc47d${_scopeId}>Description</th><th data-v-9debc47d${_scopeId}>Actions</th></tr></thead><tbody data-v-9debc47d${_scopeId}><!--[-->`);
              ssrRenderList(__props.stockOpnameProducts.data, (product, index) => {
                ...
                })}" data-v-9debc47d${_scopeId}><td data-v-9debc47d${_scopeId}>${ssrInterpolate(getRowNumber(index))}</td><td data-v-9debc47d${_scopeId}>${ssrInterpolate(((_a = product.product) == null ? void 0 : _a.product_unit_sku) || "-")}</td><td data-v-9debc47d${_scopeId}>${ssrInterpolate(((_b = product.product) == null ? void 0 : _b.product_name) || "-")}</td>`);
                if (isOwner.value) {
                  _push2(`<td data-v-9debc47d${_scopeId}>${ssrInterpolate(unref(formatNumberWithCommas)(
                ...
                ))}</td><td data-v-9debc47d${_scopeId}>${ssrInterpolate(unref(formatNumberWithCommas)(
                  product.expired_quantity || 0
                ))}</td>`);
                if (isOwner.value) {
                  _push2(`<td data-v-9debc47d${_scopeId}><span class="${ssrRenderClass(
                    getStockDifference(product) === 0 ? "text-success" : "text-danger fw-bold"
                  )}" data-v-9debc47d${_scopeId}>${ssrInterpolate(getStockDifference(product) > 0 ? "+" : "")}${ssrInterpolate(unref(formatNumberWithCommas)(
                ...
                )}" data-v-9debc47d${_scopeId}>${ssrInterpolate(getStatusBadge(product.status).text)}</span></td><td data-v-9debc47d${_scopeId}>`);
                if (product.description) {
                  _push2(`<span class="text-truncate cursor-pointer" style="${ssrRenderStyle({ "cursor": "pointer" })}"${ssrRenderAttr("title", product.description)} data-v-9debc47d${_scopeId}>${ssrInterpolate(truncateText(product.description))}</span>`);
                } else {
                  _push2(`<span class="text-muted" data-v-9debc47d${_scopeId}>-</span>`);
                }
                _push2(`</td><td data-v-9debc47d${_scopeId}>`);
                if (!isSubmitted.value) {
                  _push2(`<div class="btn-group btn-group-sm" data-v-9debc47d${_scopeId}><button class="btn btn-outline-danger btn-sm" title="Hapus Product" data-v-9debc47d${_scopeId}><i class="fas fa-trash" data-v-9debc47d${_scopeId}></i></button></div>`);
                } else if (isOwner.value && hasStockDiscrepancy(product) && product.status === "PENDING") {
                  _push2(`<div class="btn-group btn-group-sm" data-v-9debc47d${_scopeId}><button class="btn btn-success btn-sm" title="Update Stock ke System" data-v-9debc47d${_scopeId}><i class="fas fa-sync-alt me-1" data-v-9debc47d${_scopeId}></i> Update </button><button class="btn btn-warning btn-sm" title="Abaikan Perbedaan" data-v-9debc47d${_scopeId}><i class="fas fa-times me-1" data-v-9debc47d${_scopeId}></i> Abaikan </button></div>`);
                } else {
                  _push2(`<span class="text-muted" data-v-9debc47d${_scopeId}>-</span>`);
                }
                _push2(`</td></tr>`);
            ...
            if (__props.stockOpnameProducts.data.length === 0) {
              _push2(`<div class="py-4 text-center" data-v-9debc47d${_scopeId}><p class="text-muted" data-v-9debc47d${_scopeId}>No stock opname products found.</p></div>`);
            } else {
              _push2(`<!---->`);
            }
            ...
            if (!isSubmitted.value && __props.stockOpnameProducts.data.length > 0) {
              _push2(`<div class="mt-4 text-center" data-v-9debc47d${_scopeId}><button class="btn btn-lg btn-success" data-v-9debc47d${_scopeId}><i class="fas fa-lock me-2" data-v-9debc47d${_scopeId}></i> Submit Stock Opname </button><p class="text-muted mt-2" data-v-9debc47d${_scopeId}><small data-v-9debc47d${_scopeId}>Setelah submit, Anda tidak dapat menambah atau menghapus product.</small></p></div>`);
            } else {
              _push2(`<!---->`);
            }
            _push2(`</div></div>`);
...
const Index = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-9debc47d"]]);
export {
  Index as default
};
