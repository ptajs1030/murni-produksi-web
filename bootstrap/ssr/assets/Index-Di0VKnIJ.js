    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(_sfc_main$1, { title: "Daftar Property Item" }, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div class="card mb-3" data-v-cba05706${_scopeId}><div class="card-body" data-v-cba05706${_scopeId}><div class="row g-3 align-items-end" data-v-cba05706${_scopeId}><div class="col-md-4" data-v-cba05706${_scopeId}><label class="form-label" data-v-cba05706${_scopeId}>Pencarian</label>`);
            ...
            _push2(`</div><div class="col-md-2" data-v-cba05706${_scopeId}>`);
            if (hasActiveFilters.value) {
              _push2(`<button class="btn btn-outline-secondary" data-v-cba05706${_scopeId}><i class="fas fa-times me-1" data-v-cba05706${_scopeId}></i> Clear </button>`);
            } else {
              _push2(`<!---->`);
            }
            _push2(`</div><div class="col-md-6 text-end" data-v-cba05706${_scopeId}><button class="btn btn-primary" data-v-cba05706${_scopeId}><i class="fas fa-plus me-1" data-v-cba05706${_scopeId}></i> Tambah Property Item </button></div></div></div></div><div class="d-flex justify-content-between align-items-center mb-3" data-v-cba05706${_scopeId}><div class="text-muted" data-v-cba05706${_scopeId}> Menampilkan ${ssrInterpolate(__props.propertyItems.from || 0)} - ${ssrInterpolate(__props.propertyItems.to || 0)} dari ${ssrInterpolate(__props.propertyItems.total || 0)} data </div>`);
            if (hasActiveFilters.value) {
              _push2(`<div class="text-muted" data-v-cba05706${_scopeId}><i class="fas fa-filter me-1" data-v-cba05706${_scopeId}></i> Filter aktif </div>`);
            } else {
              _push2(`<!---->`);
            }
            _push2(`</div><div class="card" data-v-cba05706${_scopeId}><div class="table-responsive" data-v-cba05706${_scopeId}><table class="table-hover mb-0 table" data-v-cba05706${_scopeId}><thead class="table-light" data-v-cba05706${_scopeId}><tr data-v-cba05706${_scopeId}><th class="text-center" style="${ssrRenderStyle({ "width": "60px" })}" data-v-cba05706${_scopeId}>#</th><th class="${ssrRenderClass({
              sortable: isSortable("property_code")
            })}" style="${ssrRenderStyle({ "cursor": "pointer" })}" data-v-cba05706${_scopeId}> Kode Property `);
            if (isSortable("property_code")) {
              _push2(`<i class="${ssrRenderClass([getSortIcon("property_code"), "ms-1"])}" data-v-cba05706${_scopeId}></i>`);
            } else {
              _push2(`<!---->`);
            }
            _push2(`</th><th class="${ssrRenderClass({
              sortable: isSortable("property_name")
            })}" style="${ssrRenderStyle({ "cursor": "pointer" })}" data-v-cba05706${_scopeId}> Nama Property `);
            if (isSortable("property_name")) {
              _push2(`<i class="${ssrRenderClass([getSortIcon("property_name"), "ms-1"])}" data-v-cba05706${_scopeId}></i>`);
            } else {
              _push2(`<!---->`);
            }
            _push2(`</th><th class="${ssrRenderClass({ sortable: isSortable("created_at") })}" style="${ssrRenderStyle({ "cursor": "pointer" })}" data-v-cba05706${_scopeId}> Tanggal Dibuat `);
            if (isSortable("created_at")) {
              _push2(`<i class="${ssrRenderClass([getSortIcon("created_at"), "ms-1"])}" data-v-cba05706${_scopeId}></i>`);
            } else {
              _push2(`<!---->`);
            }
            _push2(`</th><th class="text-center" style="${ssrRenderStyle({ "width": "120px" })}" data-v-cba05706${_scopeId}>Aksi</th></tr></thead><tbody data-v-cba05706${_scopeId}>`);
            if (__props.propertyItems.data && __props.propertyItems.data.length === 0) {
              _push2(`<tr data-v-cba05706${_scopeId}><td colspan="5" class="text-muted py-4 text-center" data-v-cba05706${_scopeId}><i class="fas fa-inbox fa-2x d-block mb-2" data-v-cba05706${_scopeId}></i>`);
              if (search.value) {
                _push2(`<div data-v-cba05706${_scopeId}>Tidak ada data yang sesuai dengan pencarian &quot;${ssrInterpolate(search.value)}&quot;</div>`);
              } else {
                _push2(`<div data-v-cba05706${_scopeId}>Belum ada data property item</div>`);
              }
              _push2(`</td></tr>`);
            } else {
              _push2(`<!--[-->`);
              ssrRenderList(__props.propertyItems.data, (propertyItem, index) => {
                _push2(`<tr data-v-cba05706${_scopeId}><td class="text-muted text-center" data-v-cba05706${_scopeId}>${ssrInterpolate(__props.propertyItems.from + index)}</td><td data-v-cba05706${_scopeId}><span class="badge bg-secondary" data-v-cba05706${_scopeId}>${ssrInterpolate(propertyItem.property_code)}</span></td><td class="fw-medium" data-v-cba05706${_scopeId}>${ssrInterpolate(propertyItem.property_name)}</td><td class="text-muted" data-v-cba05706${_scopeId}>${ssrInterpolate(new Date(propertyItem.created_at).toLocaleDateString("id-ID", {
                  year: "numeric",
                  month: "short",
                  day: "numeric"
                }))}</td><td class="text-center" data-v-cba05706${_scopeId}><div class="btn-group btn-group-md" role="group" data-v-cba05706${_scopeId}><button class="btn btn-outline-warning" title="Edit Property Item" data-v-cba05706${_scopeId}><i class="fas fa-edit" data-v-cba05706${_scopeId}></i></button><button class="btn btn-outline-danger" title="Hapus Property Item" data-v-cba05706${_scopeId}><i class="fas fa-trash" data-v-cba05706${_scopeId}></i></button></div></td></tr>`);
              });
              _push2(`<!--]-->`);
            }
            _push2(`</tbody></table></div></div><div class="mt-3" data-v-cba05706${_scopeId}>`);
            ...
            return [
              ...
              createVNode("div", { class: "d-flex justify-content-between align-items-center mb-3" }, [
                createVNode("div", { class: "text-muted" }, " Menampilkan " + toDisplayString(__props.propertyItems.from || 0) + " - " + toDisplayString(__props.propertyItems.to || 0) + " dari " + toDisplayString(__props.propertyItems.total || 0) + " data ", 1),
                    ...
                    createVNode("tbody", null, [
                      __props.propertyItems.data && __props.propertyItems.data.length === 0 ? (openBlock(), createBlock("tr", { key: 0 }, [
                        ...
                        return openBlock(), createBlock("tr", {
                          ...
                          createVNode("td", { class: "text-muted" }, toDisplayString(new Date(propertyItem.created_at).toLocaleDateString("id-ID", {
                            year: "numeric",
                            month: "short",
                            day: "numeric"
                          })), 1),
...
const Index = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-cba05706"]]);
export {
  Index as default
};
