    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(_sfc_main$1, { title: "Daftar Status Repack" }, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div class="overflow-hidden bg-white shadow-sm sm:rounded-lg" data-v-9bcc275e${_scopeId}><div class="p-3 text-gray-900" data-v-9bcc275e${_scopeId}><div class="d-flex justify-content-between align-items-center mb-3" data-v-9bcc275e${_scopeId}><div class="d-flex align-items-center gap-3" data-v-9bcc275e${_scopeId}>`);
            ...
            if (hasActiveFilters.value) {
              _push2(`<button class="btn btn-outline-secondary" data-v-9bcc275e${_scopeId}><i class="fas fa-times me-1" data-v-9bcc275e${_scopeId}></i> Clear </button>`);
            } else {
              _push2(`<!---->`);
            }
            _push2(`</div><button class="btn btn-primary" data-v-9bcc275e${_scopeId}><i class="fas fa-plus me-1" data-v-9bcc275e${_scopeId}></i> Tambah Status Repack </button></div></div></div><div class="card" data-v-9bcc275e${_scopeId}><div class="table-responsive" data-v-9bcc275e${_scopeId}><table class="table-hover mb-0 table" data-v-9bcc275e${_scopeId}><thead class="table-light" data-v-9bcc275e${_scopeId}><tr data-v-9bcc275e${_scopeId}><th class="text-center" style="${ssrRenderStyle({ "width": "60px" })}" data-v-9bcc275e${_scopeId}>#</th><th class="${ssrRenderClass({
              sortable: isSortable("repack_code")
            })}" style="${ssrRenderStyle({ "cursor": "pointer" })}" data-v-9bcc275e${_scopeId}> Kode Status Repack `);
            if (isSortable("repack_code")) {
              _push2(`<i class="${ssrRenderClass([getSortIcon("repack_code"), "ms-1"])}" data-v-9bcc275e${_scopeId}></i>`);
            } else {
              _push2(`<!---->`);
            }
            _push2(`</th><th class="${ssrRenderClass({
              sortable: isSortable("repack_name")
            })}" style="${ssrRenderStyle({ "cursor": "pointer" })}" data-v-9bcc275e${_scopeId}> Nama Status Repack `);
            if (isSortable("repack_name")) {
              _push2(`<i class="${ssrRenderClass([getSortIcon("repack_name"), "ms-1"])}" data-v-9bcc275e${_scopeId}></i>`);
            } else {
              _push2(`<!---->`);
            }
            _push2(`</th><th class="${ssrRenderClass({ sortable: isSortable("created_at") })}" style="${ssrRenderStyle({ "cursor": "pointer" })}" data-v-9bcc275e${_scopeId}> Tanggal Dibuat `);
            if (isSortable("created_at")) {
              _push2(`<i class="${ssrRenderClass([getSortIcon("created_at"), "ms-1"])}" data-v-9bcc275e${_scopeId}></i>`);
            } else {
              _push2(`<!---->`);
            }
            _push2(`</th><th class="text-center" style="${ssrRenderStyle({ "width": "120px" })}" data-v-9bcc275e${_scopeId}> Aksi </th></tr></thead><tbody data-v-9bcc275e${_scopeId}>`);
            if (__props.repack_statuses.data && __props.repack_statuses.data.length === 0) {
              _push2(`<tr data-v-9bcc275e${_scopeId}><td colspan="5" class="text-muted py-4 text-center" data-v-9bcc275e${_scopeId}><i class="fas fa-inbox fa-2x d-block mb-2" data-v-9bcc275e${_scopeId}></i>`);
              if (search.value) {
                _push2(`<div data-v-9bcc275e${_scopeId}> Tidak ada data yang sesuai dengan pencarian &quot;${ssrInterpolate(search.value)}&quot; </div>`);
              } else {
                _push2(`<div data-v-9bcc275e${_scopeId}>Belum ada data status repack</div>`);
              }
              _push2(`</td></tr>`);
            } else {
              _push2(`<!--[-->`);
              ssrRenderList(__props.repack_statuses.data, (repack_status, index) => {
                _push2(`<tr data-v-9bcc275e${_scopeId}><td class="text-muted text-center" data-v-9bcc275e${_scopeId}>${ssrInterpolate(__props.repack_statuses.from + index)}</td><td data-v-9bcc275e${_scopeId}><span class="badge bg-secondary" data-v-9bcc275e${_scopeId}>${ssrInterpolate(repack_status.repack_code)}</span></td><td class="fw-medium" data-v-9bcc275e${_scopeId}>${ssrInterpolate(repack_status.repack_name)}</td><td class="text-muted" data-v-9bcc275e${_scopeId}>${ssrInterpolate(new Date(
                  repack_status.created_at
                ).toLocaleDateString("id-ID", {
                  year: "numeric",
                  month: "short",
                  day: "numeric"
                }))}</td><td class="text-center" data-v-9bcc275e${_scopeId}><div class="btn-group btn-group-md" role="group" data-v-9bcc275e${_scopeId}><button class="btn btn-outline-warning" title="Edit Status Repack" data-v-9bcc275e${_scopeId}><i class="fas fa-edit" data-v-9bcc275e${_scopeId}></i></button><button class="btn btn-outline-danger" title="Hapus Status Repack" data-v-9bcc275e${_scopeId}><i class="fas fa-trash" data-v-9bcc275e${_scopeId}></i></button></div></td></tr>`);
              });
              _push2(`<!--]-->`);
            }
            _push2(`</tbody></table></div></div><div class="mt-3" data-v-9bcc275e${_scopeId}>`);
...
const Index = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-9bcc275e"]]);
export {
  Index as default
};
