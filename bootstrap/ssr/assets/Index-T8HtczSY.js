...
const _sfc_main = {
  ...
  props: ["packagingSizes", "packagingSizeTypes", "packagingSizeLevels", "filters"],
  setup(__props) {
    const props = __props;
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(_sfc_main$1, { title: "Daftar Ukuran Kemasan" }, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div class="card mb-3" data-v-11811fb8${_scopeId}><div class="card-body" data-v-11811fb8${_scopeId}><div class="row g-3 align-items-end" data-v-11811fb8${_scopeId}><div class="col-md-4" data-v-11811fb8${_scopeId}><label class="form-label" data-v-11811fb8${_scopeId}>Pencarian</label>`);
            ...
            _push2(`</div><div class="col-md-2" data-v-11811fb8${_scopeId}>`);
            if (hasActiveFilters.value) {
              _push2(`<button class="btn btn-outline-secondary" data-v-11811fb8${_scopeId}><i class="fas fa-times me-1" data-v-11811fb8${_scopeId}></i> Clear </button>`);
            } else {
              _push2(`<!---->`);
            }
            _push2(`</div><div class="col-md-6 text-end" data-v-11811fb8${_scopeId}><button class="btn btn-primary" data-v-11811fb8${_scopeId}><i class="fas fa-plus me-1" data-v-11811fb8${_scopeId}></i> Tambah Ukuran Kemasan </button></div></div></div></div><div class="d-flex justify-content-between align-items-center mb-3" data-v-11811fb8${_scopeId}><div class="text-muted" data-v-11811fb8${_scopeId}> Menampilkan ${ssrInterpolate(__props.packagingSizes.from || 0)} - ${ssrInterpolate(__props.packagingSizes.to || 0)} dari ${ssrInterpolate(__props.packagingSizes.total || 0)} data </div>`);
            if (hasActiveFilters.value) {
              _push2(`<div class="text-muted" data-v-11811fb8${_scopeId}><i class="fas fa-filter me-1" data-v-11811fb8${_scopeId}></i> Filter aktif </div>`);
            } else {
              _push2(`<!---->`);
            }
            _push2(`</div><div class="card" data-v-11811fb8${_scopeId}><div class="table-responsive" data-v-11811fb8${_scopeId}><table class="table-hover mb-0 table" data-v-11811fb8${_scopeId}><thead class="table-light" data-v-11811fb8${_scopeId}><tr data-v-11811fb8${_scopeId}><th class="text-center" style="${ssrRenderStyle({ "width": "60px" })}" data-v-11811fb8${_scopeId}>#</th><th class="${ssrRenderClass({
              sortable: isSortable("packaging_size_code")
            })}" style="${ssrRenderStyle({ "cursor": "pointer" })}" data-v-11811fb8${_scopeId}> Kode Ukuran Kemasan `);
            if (isSortable("packaging_size_code")) {
              _push2(`<i class="${ssrRenderClass([getSortIcon("packaging_size_code"), "ms-1"])}" data-v-11811fb8${_scopeId}></i>`);
            } else {
              _push2(`<!---->`);
            }
            _push2(`</th><th class="${ssrRenderClass({
              sortable: isSortable("packaging_size_name")
            })}" style="${ssrRenderStyle({ "cursor": "pointer" })}" data-v-11811fb8${_scopeId}> Nama Ukuran Kemasan `);
            if (isSortable("packaging_size_name")) {
              _push2(`<i class="${ssrRenderClass([getSortIcon("packaging_size_name"), "ms-1"])}" data-v-11811fb8${_scopeId}></i>`);
            } else {
              _push2(`<!---->`);
            }
            _push2(`</th><th class="${ssrRenderClass({
              sortable: isSortable("packaging_size_name")
            })}" style="${ssrRenderStyle({ "cursor": "pointer" })}" data-v-11811fb8${_scopeId}> Conversion Kemasan `);
            if (isSortable("unit_conversion_value")) {
              _push2(`<i class="${ssrRenderClass([getSortIcon("unit_conversion_value"), "ms-1"])}" data-v-11811fb8${_scopeId}></i>`);
            } else {
              _push2(`<!---->`);
            }
            _push2(`</th><th data-v-11811fb8${_scopeId}>Tipe Ukuran</th><th data-v-11811fb8${_scopeId}>Level Ukuran</th><th class="${ssrRenderClass({ sortable: isSortable("created_at") })}" style="${ssrRenderStyle({ "cursor": "pointer" })}" data-v-11811fb8${_scopeId}> Tanggal Dibuat `);
            if (isSortable("created_at")) {
              _push2(`<i class="${ssrRenderClass([getSortIcon("created_at"), "ms-1"])}" data-v-11811fb8${_scopeId}></i>`);
            } else {
              _push2(`<!---->`);
            }
            _push2(`</th><th class="text-center" style="${ssrRenderStyle({ "width": "120px" })}" data-v-11811fb8${_scopeId}>Aksi</th></tr></thead><tbody data-v-11811fb8${_scopeId}>`);
            if (__props.packagingSizes.data && __props.packagingSizes.data.length === 0) {
              _push2(`<tr data-v-11811fb8${_scopeId}><td colspan="7" class="text-muted py-4 text-center" data-v-11811fb8${_scopeId}><i class="fas fa-inbox fa-2x d-block mb-2" data-v-11811fb8${_scopeId}></i>`);
              if (search.value) {
                _push2(`<div data-v-11811fb8${_scopeId}>Tidak ada data yang sesuai dengan pencarian &quot;${ssrInterpolate(search.value)}&quot;</div>`);
              } else {
                _push2(`<div data-v-11811fb8${_scopeId}>Belum ada data ukuran kemasan</div>`);
              }
              _push2(`</td></tr>`);
            } else {
              _push2(`<!--[-->`);
              ssrRenderList(__props.packagingSizes.data, (packagingSize, index) => {
                var _a, _b;
                _push2(`<tr data-v-11811fb8${_scopeId}><td class="text-muted text-center" data-v-11811fb8${_scopeId}>${ssrInterpolate(__props.packagingSizes.from + index)}</td><td data-v-11811fb8${_scopeId}><span class="badge bg-secondary" data-v-11811fb8${_scopeId}>${ssrInterpolate(packagingSize.packaging_size_code)}</span></td><td class="fw-medium" data-v-11811fb8${_scopeId}>${ssrInterpolate(packagingSize.packaging_size_name)}</td><td class="text-center" data-v-11811fb8${_scopeId}><span class="badge bg-info text-dark" data-v-11811fb8${_scopeId}>${ssrInterpolate(packagingSize.unit_conversion_value ?? "N/A")}</span></td><td data-v-11811fb8${_scopeId}><span class="badge bg-info text-dark" data-v-11811fb8${_scopeId}>${ssrInterpolate(((_a = packagingSize.size_type) == null ? void 0 : _a.type_description) || "N/A")}</span></td><td data-v-11811fb8${_scopeId}><span class="badge bg-success" data-v-11811fb8${_scopeId}>${ssrInterpolate(((_b = packagingSize.size_level) == null ? void 0 : _b.level_description) || "N/A")}</span></td><td class="text-muted" data-v-11811fb8${_scopeId}>${ssrInterpolate(new Date(packagingSize.created_at).toLocaleDateString("id-ID", {
                  year: "numeric",
                  month: "short",
                  day: "numeric"
                }))}</td><td class="text-center" data-v-11811fb8${_scopeId}><div class="btn-group btn-group-md" role="group" data-v-11811fb8${_scopeId}><button class="btn btn-outline-warning" title="Edit Ukuran Kemasan" data-v-11811fb8${_scopeId}><i class="fas fa-edit" data-v-11811fb8${_scopeId}></i></button><button class="btn btn-outline-danger" title="Hapus Ukuran Kemasan" data-v-11811fb8${_scopeId}><i class="fas fa-trash" data-v-11811fb8${_scopeId}></i></button></div></td></tr>`);
              });
              _push2(`<!--]-->`);
            }
            _push2(`</tbody></table></div></div><div class="mt-3" data-v-11811fb8${_scopeId}>`);
            ...
            return [
              ...
              createVNode("div", { class: "d-flex justify-content-between align-items-center mb-3" }, [
                createVNode("div", { class: "text-muted" }, " Menampilkan " + toDisplayString(__props.packagingSizes.from || 0) + " - " + toDisplayString(__props.packagingSizes.to || 0) + " dari " + toDisplayString(__props.packagingSizes.total || 0) + " data ", 1),
                      ...
                      createVNode("tr", null, [
                        ...
                        createVNode("th", {
                          ...
                          isSortable("unit_conversion_value") ? (openBlock(), createBlock("i", {
                            key: 0,
                            class: [getSortIcon("unit_conversion_value"), "ms-1"]
                          }, null, 2)) : createCommentVNode("", true)
                        ], 10, ["onClick"]),
                    ...
                    createVNode("tbody", null, [
                      __props.packagingSizes.data && __props.packagingSizes.data.length === 0 ? (openBlock(), createBlock("tr", { key: 0 }, [
                        ...
                        return openBlock(), createBlock("tr", {
                          ...
                          createVNode("td", { class: "text-muted" }, toDisplayString(new Date(packagingSize.created_at).toLocaleDateString("id-ID", {
                            year: "numeric",
                            month: "short",
                            day: "numeric"
                          })), 1),
                          createVNode("td", { class: "text-center" }, [
                            createVNode("div", {
                              ...
                              createVNode("button", {
                                onClick: ($event) => deletePackagingSize(packagingSize.id),
...
const Index = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-11811fb8"]]);
export {
  Index as default
};
