    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(_sfc_main$1, { title: "Riwayat Transaksi" }, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div class="overflow-hidden bg-white shadow-sm sm:rounded-lg" data-v-7966b7a8${_scopeId}><div class="p-3 text-gray-900" data-v-7966b7a8${_scopeId}><div class="mb-3" data-v-7966b7a8${_scopeId}><div class="row g-2 align-items-end" data-v-7966b7a8${_scopeId}><div class="col-md-4" data-v-7966b7a8${_scopeId}><label class="form-label small text-muted mb-1" data-v-7966b7a8${_scopeId}>Cari</label>`);
            ...
            _push2(`</div><div class="col-md-2" data-v-7966b7a8${_scopeId}><label class="form-label small text-muted mb-1" data-v-7966b7a8${_scopeId}>Dari Tanggal</label><input${ssrRenderAttr("value", dateFrom.value)} type="date" class="form-control" data-v-7966b7a8${_scopeId}></div><div class="col-md-2" data-v-7966b7a8${_scopeId}><label class="form-label small text-muted mb-1" data-v-7966b7a8${_scopeId}>Sampai Tanggal</label><input${ssrRenderAttr("value", dateTo.value)} type="date" class="form-control" data-v-7966b7a8${_scopeId}></div><div class="col-md-2" data-v-7966b7a8${_scopeId}><label class="form-label small text-muted mb-1" data-v-7966b7a8${_scopeId}>Tipe Produk</label><select class="form-select" data-v-7966b7a8${_scopeId}><option value="" data-v-7966b7a8${ssrIncludeBooleanAttr(Array.isArray(productType.value) ? ssrLooseContain(productType.value, "") : ssrLooseEqual(productType.value, "")) ? " selected" : ""}${_scopeId}>Semua</option><option value="Produk Bahan Baku" data-v-7966b7a8${ssrIncludeBooleanAttr(Array.isArray(productType.value) ? ssrLooseContain(productType.value, "Produk Bahan Baku") : ssrLooseEqual(productType.value, "Produk Bahan Baku")) ? " selected" : ""}${_scopeId}> Bahan Baku </option><option value="Produk Jadi" data-v-7966b7a8${ssrIncludeBooleanAttr(Array.isArray(productType.value) ? ssrLooseContain(productType.value, "Produk Jadi") : ssrLooseEqual(productType.value, "Produk Jadi")) ? " selected" : ""}${_scopeId}>Produk Jadi</option></select></div><div class="col-md-2" data-v-7966b7a8${_scopeId}><label class="form-label small text-muted mb-1" data-v-7966b7a8${_scopeId}>Tipe Transaksi</label><select class="form-select" data-v-7966b7a8${_scopeId}><option value="" data-v-7966b7a8${ssrIncludeBooleanAttr(Array.isArray(transactionTypeId.value) ? ssrLooseContain(transactionTypeId.value, "") : ssrLooseEqual(transactionTypeId.value, "")) ? " selected" : ""}${_scopeId}>Semua</option><!--[-->`);
            ssrRenderList(__props.transactionTypes, (t) => {
              _push2(`<option${ssrRenderAttr("value", t.id)} data-v-7966b7a8${ssrIncludeBooleanAttr(Array.isArray(transactionTypeId.value) ? ssrLooseContain(transactionTypeId.value, t.id) : ssrLooseEqual(transactionTypeId.value, t.id)) ? " selected" : ""}${_scopeId}>${ssrInterpolate(t.transaction_type_name)}</option>`);
            });
            _push2(`<!--]--></select></div><div class="col-md-auto" data-v-7966b7a8${_scopeId}><button class="btn btn-outline-secondary w-100" data-v-7966b7a8${_scopeId}><i class="fas fa-undo me-1" data-v-7966b7a8${_scopeId}></i> Reset </button></div></div></div>`);
            if (__props.transactions.data.length > 0) {
              _push2(`<div class="table-responsive" data-v-7966b7a8${_scopeId}><table class="table-bordered table-striped table" data-v-7966b7a8${_scopeId}><thead class="table-light" data-v-7966b7a8${_scopeId}><tr data-v-7966b7a8${_scopeId}><th style="${ssrRenderStyle({ "width": "60px" })}" data-v-7966b7a8${_scopeId}>No.</th><th data-v-7966b7a8${_scopeId}>Produk</th><th style="${ssrRenderStyle({ "width": "130px" })}" data-v-7966b7a8${_scopeId}>Tipe Transaksi</th><th style="${ssrRenderStyle({ "width": "100px" })}" data-v-7966b7a8${_scopeId}>Qty</th><th style="${ssrRenderStyle({ "width": "180px" })}" data-v-7966b7a8${_scopeId}>Tanggal Transaksi</th><th data-v-7966b7a8${_scopeId}>Notes</th><th style="${ssrRenderStyle({ "width": "150px" })}" data-v-7966b7a8${_scopeId}>PIC</th></tr></thead><tbody data-v-7966b7a8${_scopeId}><!--[-->`);
              ssrRenderList(__props.transactions.data, (txn, index) => {
                var _a2, _b2, _c2, _d2, _e2, _f;
                _push2(`<tr data-v-7966b7a8${_scopeId}><td data-v-7966b7a8${_scopeId}>${ssrInterpolate(getRowNumber(index))}</td><td data-v-7966b7a8${_scopeId}>${ssrInterpolate(((_a2 = txn.product) == null ? void 0 : _a2.product_name) || "-")} <br data-v-7966b7a8${_scopeId}><small class="text-muted" data-v-7966b7a8${_scopeId}>${ssrInterpolate(((_b2 = txn.product) == null ? void 0 : _b2.product_type) || "")}</small></td><td class="text-center" data-v-7966b7a8${_scopeId}><span class="${ssrRenderClass([
                  getTypeBadge(
                    (_c2 = txn.transaction_type) == null ? void 0 : _c2.transaction_type_name
                  ),
                  "badge"
                ])}" data-v-7966b7a8${_scopeId}>${ssrInterpolate(((_d2 = txn.transaction_type) == null ? void 0 : _d2.transaction_type_name) || "-")}</span></td><td class="text-center" data-v-7966b7a8${_scopeId}>`);
                if (txn.quantity > 0) {
                  _push2(`<span class="badge bg-success" data-v-7966b7a8${_scopeId}>${ssrInterpolate(txn.quantity)}</span>`);
                } else {
                  _push2(`<span class="badge bg-danger" data-v-7966b7a8${_scopeId}>${ssrInterpolate(txn.quantity)}</span>`);
                }
                _push2(`</td><td data-v-7966b7a8${_scopeId}>${ssrInterpolate(formatDate(txn.transaction_date))}</td><td data-v-7966b7a8${_scopeId}><small data-v-7966b7a8${_scopeId}>${ssrInterpolate(txn.notes || "-")}</small></td><td data-v-7966b7a8${_scopeId}>${ssrInterpolate(((_e2 = txn.created_by_user) == null ? void 0 : _e2.name) || ((_f = txn.created_by) == null ? void 0 : _f.name) || "-")}</td></tr>`);
              });
            ...
            if (__props.transactions.data.length === 0) {
              _push2(`<div class="py-4 text-center" data-v-7966b7a8${_scopeId}><p class="text-muted" data-v-7966b7a8${_scopeId}> Tidak ada riwayat transaksi ditemukan. </p></div>`);
            } else {
              _push2(`<!---->`);
            }
...
const Index = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-7966b7a8"]]);
export {
  Index as default
};
