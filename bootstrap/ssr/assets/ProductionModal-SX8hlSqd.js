    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(ssrRenderComponent(_sfc_main$1, mergeProps({
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<form data-v-9136175f${_scopeId}><div class="modal-header" data-v-9136175f${_scopeId}><h5 class="modal-title" data-v-9136175f${_scopeId}>Menu Produksi</h5><button type="button" class="btn-close" data-v-9136175f${_scopeId}></button></div><div class="modal-body" data-v-9136175f${_scopeId}><div class="row" data-v-9136175f${_scopeId}><div class="col-md-5" data-v-9136175f${_scopeId}><div class="card mb-3" data-v-9136175f${_scopeId}><div class="card-header bg-primary text-white" data-v-9136175f${_scopeId}><strong data-v-9136175f${_scopeId}>Pilih Produk Master</strong></div><div class="card-body" data-v-9136175f${_scopeId}><div class="mb-3" data-v-9136175f${_scopeId}>`);
            _push2(ssrRenderComponent(_sfc_main$2, {
              for: "recipe-select",
              value: "Resep"
            }, null, _parent2, _scopeId));
            _push2(`<select id="recipe-select" class="form-select" required data-v-9136175f${_scopeId}><option value="" data-v-9136175f${ssrIncludeBooleanAttr(Array.isArray(unref(form).recipe_id) ? ssrLooseContain(unref(form).recipe_id, "") : ssrLooseEqual(unref(form).recipe_id, "")) ? " selected" : ""}${_scopeId}> -- Pilih Resep -- </option><!--[-->`);
            ssrRenderList(__props.recipes, (recipe) => {
              var _a;
              _push2(`<option${ssrRenderAttr("value", recipe.id)} data-v-9136175f${ssrIncludeBooleanAttr(Array.isArray(unref(form).recipe_id) ? ssrLooseContain(unref(form).recipe_id, recipe.id) : ssrLooseEqual(unref(form).recipe_id, recipe.id)) ? " selected" : ""}${_scopeId}>${ssrInterpolate(((_a = recipe.product) == null ? void 0 : _a.product_name) || `Resep #${recipe.id}`)}</option>`);
            });
            _push2(`<!--]--></select>`);
            ...
            _push2(`</div><div class="mb-3" data-v-9136175f${_scopeId}>`);
            _push2(ssrRenderComponent(_sfc_main$2, {
              for: "quantity",
              value: "Jumlah"
            }, null, _parent2, _scopeId));
            ...
            _push2(`</div><div class="d-grid gap-2" data-v-9136175f${_scopeId}><button type="button" class="btn btn-warning"${ssrIncludeBooleanAttr(
              isLoading.value || !unref(form).recipe_id || !unref(form).quantity
            ) ? " disabled" : ""} data-v-9136175f${_scopeId}>`);
            if (isLoading.value) {
              _push2(`<span data-v-9136175f${_scopeId}><i class="fas fa-spinner fa-spin me-1" data-v-9136175f${_scopeId}></i> Memuat... </span>`);
            } else {
              _push2(`<span data-v-9136175f${_scopeId}><i class="fas fa-search me-1" data-v-9136175f${_scopeId}></i> Cek </span>`);
            }
            _push2(`</button></div></div></div></div><div class="col-md-7" data-v-9136175f${_scopeId}><div class="card h-100" data-v-9136175f${_scopeId}><div class="card-header bg-success text-white" data-v-9136175f${_scopeId}><strong data-v-9136175f${_scopeId}>Resep/Racikan</strong><small class="d-block" data-v-9136175f${_scopeId}> Preview produk yang terpakai (otomatis terisi ketika pencet tombol cek) </small></div><div class="card-body" data-v-9136175f${_scopeId}>`);
            if (ingredientsPreview.value.length === 0) {
              _push2(`<div class="text-center text-muted py-4" data-v-9136175f${_scopeId}><i class="fas fa-info-circle fa-2x mb-2" data-v-9136175f${_scopeId}></i><p data-v-9136175f${_scopeId}> Pilih resep dan jumlah, lalu klik &quot;Cek&quot; untuk melihat ingredients yang diperlukan. </p></div>`);
            } else {
              _push2(`<div data-v-9136175f${_scopeId}><!--[-->`);
              ssrRenderList(ingredientsPreview.value, (ingredient, index) => {
                _push2(`<div class="row mb-3 align-items-center" data-v-9136175f${_scopeId}><div class="col-md-6" data-v-9136175f${_scopeId}>`);
                _push2(ssrRenderComponent(_sfc_main$2, { value: "Produk" }, null, _parent2, _scopeId));
                _push2(`<div class="form-control bg-light" data-v-9136175f${_scopeId}>${ssrInterpolate(ingredient.product_name)}</div></div><div class="col-md-4" data-v-9136175f${_scopeId}>`);
                _push2(ssrRenderComponent(_sfc_main$2, { value: "Jumlah" }, null, _parent2, _scopeId));
                _push2(`<div class="form-control bg-light" data-v-9136175f${_scopeId}>${ssrInterpolate(unref(formatNumberWithCommas)(
            ...
            if (isChecked.value) {
              _push2(`<div class="alert alert-info mt-3" role="alert" data-v-9136175f${_scopeId}><i class="fas fa-info-circle me-2" data-v-9136175f${_scopeId}></i><strong data-v-9136175f${_scopeId}>Info:</strong> Produksi ini akan menambah stok produk master dan akan mengurangi stok dari produk resepnya. </div>`);
            } else {
              _push2(`<!---->`);
            }
            _push2(`</div><div class="modal-footer" data-v-9136175f${_scopeId}><button type="button" class="btn btn-secondary me-2" data-v-9136175f${_scopeId}> Batal </button>`);
              ...
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  if (unref(form).processing) {
                    _push3(`<span data-v-9136175f${_scopeId2}><i class="fas fa-spinner fa-spin me-1" data-v-9136175f${_scopeId2}></i> Memproses... </span>`);
                  } else {
                    _push3(`<span data-v-9136175f${_scopeId2}><i class="fas fa-check me-1" data-v-9136175f${_scopeId2}></i> Submit </span>`);
                  }
                } else {
                  return [
...
const ProductionModal = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-9136175f"]]);
export {
