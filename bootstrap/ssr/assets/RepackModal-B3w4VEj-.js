import { getCurrentInstance, ref, computed, watch, mergeProps, withCtx, unref, createBlock, openBlock, createVNode, createTextVNode, withModifiers, toDisplayString, createCommentVNode, Fragment, renderList, useSSRContext } from "vue";
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(ssrRenderComponent(_sfc_main$1, mergeProps({
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          var _a, _b, _c, _d;
          if (_push2) {
            _push2(`<form data-v-3ea3fa8e${_scopeId}><div class="modal-header" data-v-3ea3fa8e${_scopeId}><h5 class="modal-title" data-v-3ea3fa8e${_scopeId}>Repack Produk</h5><button type="button" class="btn-close" data-v-3ea3fa8e${_scopeId}></button></div><div class="modal-body" data-v-3ea3fa8e${_scopeId}><div class="card mb-4" data-v-3ea3fa8e${_scopeId}><div class="card-header bg-primary text-white" data-v-3ea3fa8e${_scopeId}><strong data-v-3ea3fa8e${_scopeId}>Produk Sumber (Bahan Baku)</strong></div><div class="card-body" data-v-3ea3fa8e${_scopeId}><div class="row" data-v-3ea3fa8e${_scopeId}><div class="col-md-6" data-v-3ea3fa8e${_scopeId}><p class="mb-1" data-v-3ea3fa8e${_scopeId}><strong data-v-3ea3fa8e${_scopeId}>SKU:</strong> ${ssrInterpolate(((_a = sourceProduct.value) == null ? void 0 : _a.product_unit_sku) || "-")}</p><p class="mb-1" data-v-3ea3fa8e${_scopeId}><strong data-v-3ea3fa8e${_scopeId}>Nama:</strong> ${ssrInterpolate(((_b = sourceProduct.value) == null ? void 0 : _b.product_name) || "-")}</p><p class="mb-0" data-v-3ea3fa8e${_scopeId}><strong data-v-3ea3fa8e${_scopeId}>Stock Tersedia:</strong><span class="badge bg-info" data-v-3ea3fa8e${_scopeId}>${ssrInterpolate(unref(formatNumberWithCommas)(sourceStock.value))}</span></p></div><div class="col-md-6" data-v-3ea3fa8e${_scopeId}>`);
            ...
            _push2(`</div></div></div></div><div class="card" data-v-3ea3fa8e${_scopeId}><div class="card-header bg-success text-white d-flex justify-content-between align-items-center" data-v-3ea3fa8e${_scopeId}><strong data-v-3ea3fa8e${_scopeId}>Produk Hasil Repack</strong><button type="button" class="btn btn-light btn-sm" data-v-3ea3fa8e${_scopeId}><i class="fas fa-plus me-1" data-v-3ea3fa8e${_scopeId}></i> Tambah Produk </button></div><div class="card-body" data-v-3ea3fa8e${_scopeId}>`);
            if (unref(form).target_products.length === 0) {
              _push2(`<div class="text-center text-muted py-3" data-v-3ea3fa8e${_scopeId}><p data-v-3ea3fa8e${_scopeId}>Belum ada produk hasil repack.</p><button type="button" class="btn btn-outline-success" data-v-3ea3fa8e${_scopeId}><i class="fas fa-plus me-1" data-v-3ea3fa8e${_scopeId}></i> Tambah Produk Repack </button></div>`);
            } else {
              _push2(`<!---->`);
            }
            _push2(`<!--[-->`);
            ssrRenderList(unref(form).target_products, (target, index) => {
              _push2(`<div class="row mb-3 align-items-end" data-v-3ea3fa8e${_scopeId}><div class="col-md-6" data-v-3ea3fa8e${_scopeId}>`);
              _push2(ssrRenderComponent(_sfc_main$2, {
              ...
              _push2(`</div><div class="col-md-4" data-v-3ea3fa8e${_scopeId}>`);
              _push2(ssrRenderComponent(_sfc_main$2, {
              ...
              _push2(`</div><div class="col-md-2" data-v-3ea3fa8e${_scopeId}><button type="button" class="btn btn-outline-danger" title="Hapus" data-v-3ea3fa8e${_scopeId}><i class="fas fa-trash" data-v-3ea3fa8e${_scopeId}></i></button></div></div>`);
            });
            _push2(`<!--]-->`);
            _push2(ssrRenderComponent(_sfc_main$4, {
            ...
            _push2(`</div></div></div><div class="modal-footer" data-v-3ea3fa8e${_scopeId}><button type="button" class="btn btn-secondary me-2" data-v-3ea3fa8e${_scopeId}> Batal </button>`);
              ...
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  if (unref(form).processing) {
                    _push3(`<span data-v-3ea3fa8e${_scopeId2}><i class="fas fa-spinner fa-spin me-1" data-v-3ea3fa8e${_scopeId2}></i> Memproses... </span>`);
                  } else {
                    _push3(`<span data-v-3ea3fa8e${_scopeId2}><i class="fas fa-box-open me-1" data-v-3ea3fa8e${_scopeId2}></i> Proses Repack </span>`);
                  }
                } else {
                  return [
...
const RepackModal = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-3ea3fa8e"]]);
export {
