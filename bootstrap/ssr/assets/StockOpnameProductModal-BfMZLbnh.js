import { getCurrentInstance, ref, computed, watch, mergeProps, withCtx, unref, createBlock, openBlock, createVNode, createTextVNode, withModifiers, withDirectives, Fragment, renderList, toDisplayString, vModelSelect, vModelText, useSSRContext } from "vue";
...
const _sfc_main = {
  __name: "StockOpnameProductModal",
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(ssrRenderComponent(_sfc_main$1, mergeProps({
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<form${_scopeId}><div class="modal-header"${_scopeId}><h5 class="modal-title"${_scopeId}>Tambah Product Stock Opname</h5><button type="button" class="btn-close"${_scopeId}></button></div><div class="modal-body"${_scopeId}><div class="row"${_scopeId}><div class="col-12 mb-3"${_scopeId}>`);
            _push2(ssrRenderComponent(_sfc_main$2, {
              for: "product-select",
              value: "Pilih Product"
            }, null, _parent2, _scopeId));
            _push2(`<select id="product-select" class="form-select" required${_scopeId}><option value=""${ssrIncludeBooleanAttr(Array.isArray(unref(form).product_id) ? ssrLooseContain(unref(form).product_id, "") : ssrLooseEqual(unref(form).product_id, "")) ? " selected" : ""}${_scopeId}>-- Pilih Product --</option><!--[-->`);
            ssrRenderList(__props.products, (p) => {
              _push2(`<option${ssrRenderAttr("value", p.id)}${ssrIncludeBooleanAttr(Array.isArray(unref(form).product_id) ? ssrLooseContain(unref(form).product_id, p.id) : ssrLooseEqual(unref(form).product_id, p.id)) ? " selected" : ""}${_scopeId}>${ssrInterpolate(p.product_unit_sku)} - ${ssrInterpolate(p.product_name)}</option>`);
            });
            _push2(`<!--]--></select>`);
            ...
            _push2(ssrRenderComponent(_sfc_main$4, {
              id: "real-quantity",
              modelValue: unref(form).real_quantity,
              "onUpdate:modelValue": ($event) => unref(form).real_quantity = $event,
              type: "number",
              class: "form-control",
              min: "0",
              step: "1",
            ...
            _push2(ssrRenderComponent(_sfc_main$3, {
              message: unref(form).errors.real_quantity,
              class: "text-danger mt-1"
            }, null, _parent2, _scopeId));
            ...
            _push2(ssrRenderComponent(_sfc_main$4, {
              id: "expired-quantity",
              modelValue: unref(form).expired_quantity,
              "onUpdate:modelValue": ($event) => unref(form).expired_quantity = $event,
              type: "number",
              class: "form-control",
              min: "0",
              step: "1",
            ...
            _push2(ssrRenderComponent(_sfc_main$3, {
              message: unref(form).errors.expired_quantity,
              class: "text-danger mt-1"
            }, null, _parent2, _scopeId));
            ...
            _push2(`<textarea id="description" class="form-control" rows="3" placeholder="Masukkan deskripsi atau catatan..." maxlength="1000"${_scopeId}>${ssrInterpolate(unref(form).description)}</textarea>`);
            _push2(ssrRenderComponent(_sfc_main$3, {
            ...
            return [
              createVNode("form", {
                ...
                createVNode("div", { class: "modal-header" }, [
                  createVNode("h5", { class: "modal-title" }, "Tambah Product Stock Opname"),
                  createVNode("button", {
                    type: "button",
                    class: "btn-close",
                    onClick: close
                  ...
                  createVNode("div", { class: "row" }, [
                    createVNode("div", { class: "col-12 mb-3" }, [
                      ...
                      withDirectives(createVNode("select", {
                        ...
                        createVNode("option", { value: "" }, "-- Pilih Product --"),
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("resources/js/Pages/CoreStockOpnameProducts/StockOpnameProductModal.vue");
