import { getCurrentInstance, ref, computed, watch, mergeProps, withCtx, unref, createBlock, openBlock, createVNode, createTextVNode, withModifiers, withDirectives, vModelText, useSSRContext } from "vue";
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            _push2(ssrRenderComponent(ProductSearchInput, {
              id: "product-select",
              modelValue: unref(form).product_id,
