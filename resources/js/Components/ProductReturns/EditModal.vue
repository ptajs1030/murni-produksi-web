            ...
            <div class="modal-content">
                <form @submit.prevent="submitForm">
                    <div class="modal-header">
                        <h5 class="modal-title">Edit Product Return</h5>
...
const submitForm = () => {
    form.put(`/product-returns/${form.id}`, {
        onSuccess: () => {
            emit('success');
            emit('close');
        },
...
watch(
    ...
    newItem => {
        if (newItem && props.show) {
            form.id = newItem.id;
            form.product_id = newItem.product_id;
            form.warehouse_id = newItem.warehouse_id;
            form.out_type_id = newItem.out_type_id;
            form.packaging_size_input = newItem.packaging_size_input;
