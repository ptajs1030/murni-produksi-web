...
const form = useForm({
    ...
    expired_date: props.product.expired_date
        ? new Date(props.product.expired_date).toISOString().split("T")[0]
        : null,
    images: [],
    existing_images:
        props.product.product_images || props.product.productImages || [],
    deleted_images: [],
});
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-8">
                            ...
                            <div class="mb-3">
                                ...
                                />
                                <InputError
                                    :message="form.errors.product_unit_price"
                                    class="text-danger mt-1"
                                />
                            </div>
                            <div class="mb-3">
