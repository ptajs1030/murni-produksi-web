            ...
            <div class="table-responsive">
                <table class="table-hover mb-0 table">
                    <thead class="table-light">
                        <tr>
                            ...
                            <th
                                ...
                                @click="isSortable('category_code') && handleSort('category_code')"
                    ...
                    <tbody>
                        ...
                        <tr v-else v-for="(category, index) in categories.data" :key="category.id">
                            <td class="text-muted text-center">
                                {{ categories.from + index }}
                            </td>
                            <td>
                                <span class="badge bg-secondary">{{ category.category_code }}</span>
                            </td>
                            <td class="fw-medium">
