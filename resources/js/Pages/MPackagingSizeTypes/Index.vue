                ...
                >
                    ...
                    <div class="d-flex gap-2">
                        ...
                        <button
                            ...
                            @click="openAddPackagingSizeType"
                        >
            ...
            <div class="table-responsive">
                <table class="table-hover mb-0 table">
                    <thead class="table-light">
                        <tr>
                            ...
                            <th
                                ...
                                @click="
                                    isSortable('type_code') &&
                                    handleSort('type_code')
                                "
                                style="cursor: pointer"
                            >
                                Kode Tipe Ukuran Kemasan
                                <i
                                    v-if="isSortable('type_code')"
                                    :class="getSortIcon('type_code')"
                                    class="ms-1"
                                ></i>
                            </th>
                            <th
                                ...
                                @click="
                                    isSortable('type_description') &&
                                    handleSort('type_description')
                                "
                                style="cursor: pointer"
                            >
                    ...
                    <tbody>
                        <tr
                            v-if="
                                packagingSizeTypes.data &&
                                packagingSizeTypes.data.length === 0
                            "
                        >
                            <td colspan="5" class="text-muted py-4 text-center">
                                ...
                                <div v-else>
                                    Belum ada data tipe ukuran kemasan
                                </div>
                            </td>
                        </tr>
                        <tr
                            v-else
                            v-for="(
                                packagingSizeType, index
                            ) in packagingSizeTypes.data"
            ...
            <div class="modal-dialog modal-dialog-centered">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="mb-3">
                            <a :href="route('packaging-size-types.import-template')" class="btn btn-outline-primary">
