    ...
    <AuthenticatedLayout title="Daftar Tipe Kemasan">
            ...
            <div class="card-body">
                <div class="row g-3 align-items-end">
                    ...
                    <div class="col-md-6 text-end">
                        <button class="btn btn-primary" @click="openAddPackagingType">
        ...
        <div class="d-flex justify-content-between align-items-center mb-3">
            <div class="text-muted">
                Menampilkan {{ packaging_types.from || 0 }} - {{ packaging_types.to || 0 }} dari
                {{ packaging_types.total || 0 }} data
            </div>
        ...
        <div class="card">
            <div class="table-responsive">
                <table class="table-hover mb-0 table">
                    <thead class="table-light">
                        <tr>
                            ...
                            <th
                                ...
                                @click="isSortable('packaging_type_code') && handleSort('packaging_type_code')"
                            ...
                            <th
                                ...
                                @click="isSortable('packaging_type_name') && handleSort('packaging_type_name')"
                                style="cursor: pointer"
                            >
                                Nama Tipe Kemasan
                                <i
                    ...
                    <tbody>
                        <tr v-if="packaging_types.data && packaging_types.data.length === 0">
                        ...
                        <tr v-else v-for="(packaging_type, index) in packaging_types.data" :key="packaging_type.id">
                            <td class="text-muted text-center">
                                {{ packaging_types.from + index }}
                            </td>
                            <td>
                                <span class="badge bg-secondary">{{ packaging_type.packaging_type_code }}</span>
                            </td>
                            <td class="fw-medium">
                            ...
                            <td>
                                <span class="badge bg-info">
                                    {{ packaging_type.packaging_level?.level_description || 'N/A' }}
                                </span>
                            </td>
                            <td class="text-muted">
                                {{
                                    new Date(packaging_type.created_at).toLocaleDateString('id-ID', {
                                        year: 'numeric',
                                        month: 'short',
                                        day: 'numeric',
                                    })
                            ...
                            <td class="text-center">
                                <div class="btn-group btn-group-md" role="group">
                                    <button
                                        @click="openEditPackagingType(packaging_type)"
                                    ...
                                    <button
                                        @click="deletePackagingType(packaging_type.id)"
        ...
        <PackagingTypeFormModal ref="modalRef" :packagingLevels="packagingLevels" @saved="router.reload()" />
    </AuthenticatedLayout>
</template>
