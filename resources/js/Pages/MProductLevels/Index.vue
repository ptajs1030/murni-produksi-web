            ...
            <div class="table-responsive">
                <table class="table-hover mb-0 table">
                    <thead class="table-light">
                        <tr>
                            ...
                            <th
                                ...
                                @click="
                                    isSortable('level_code') &&
                                    handleSort('level_code')
                                "
                                style="cursor: pointer"
                            >
                                Level Code
                                <i
                                    v-if="isSortable('level_code')"
                                    :class="getSortIcon('level_code')"
                                    class="ms-1"
                                ></i>
                            </th>
                            <th
                                ...
                                @click="
                                    isSortable('level_description') &&
                                    handleSort('level_description')
                                "
                                style="cursor: pointer"
                            >
                                Description
                    ...
                    <tbody>
                        ...
                        <tr
                            v-else
                            v-for="(productLevel, index) in productLevels.data"
                            :key="productLevel.id"
                        >
                            ...
                            <td class="text-center">
                                ...
                                >
                                    ...
                                    <button
                                        @click="
                                            deleteWarehouse(productLevel.id)
                                        "
            ...
            <div class="modal-dialog modal-dialog-centered">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="mb-3">
                            <a :href="route('packaging-size-levels.import-template')" class="btn btn-outline-primary">
