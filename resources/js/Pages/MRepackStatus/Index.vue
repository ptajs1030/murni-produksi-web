    ...
    <AuthenticatedLayout title="Daftar Status Repack">
            ...
            <div class="card-body">
                <div class="row g-3 align-items-end">
                    ...
                    <div class="col-md-6 text-end">
                        <button class="btn btn-primary" @click="openAddRepackStatus">
        ...
        <div class="d-flex justify-content-between align-items-center mb-3">
            <div class="text-muted">
                Menampilkan {{ repack_statuses.from || 0 }} - {{ repack_statuses.to || 0 }} dari
                {{ repack_statuses.total || 0 }} data
            </div>
        ...
        <div class="card">
            <div class="table-responsive">
                <table class="table-hover mb-0 table">
                    <thead class="table-light">
                        <tr>
                            ...
                            <th
                                ...
                                @click="isSortable('repack_code') && handleSort('repack_code')"
                            ...
                            <th
                                ...
                                @click="isSortable('repack_name') && handleSort('repack_name')"
                                style="cursor: pointer"
                            >
                                Nama Status Repack
                                <i
                    ...
                    <tbody>
                        <tr v-if="repack_statuses.data && repack_statuses.data.length === 0">
                        ...
                        <tr v-else v-for="(repack_status, index) in repack_statuses.data" :key="repack_status.id">
                            <td class="text-muted text-center">
                                {{ repack_statuses.from + index }}
                            </td>
                            <td>
                                <span class="badge bg-secondary">{{ repack_status.repack_code }}</span>
                            </td>
                            <td class="fw-medium">
                            ...
                            <td class="text-muted">
                                {{
                                    new Date(repack_status.created_at).toLocaleDateString('id-ID', {
                                        year: 'numeric',
                                        month: 'short',
                                        day: 'numeric',
                                    })
                            ...
                            <td class="text-center">
                                <div class="btn-group btn-group-md" role="group">
                                    <button
                                        @click="openEditRepackStatus(repack_status)"
                                    ...
                                    <button
                                        @click="deleteRepackStatus(repack_status.id)"
