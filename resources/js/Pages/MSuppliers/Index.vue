    ...
    <AuthenticatedLayout title="Daftar Supplier">
            ...
            <div class="card-body">
                <div class="row g-3 align-items-end">
                    ...
                    <div class="col-md-6 text-end">
                        <button class="btn btn-primary" @click="openAddSupplier">
                            <i class="fas fa-plus me-1"></i>
                            Tambah Supplier
                        </button>
                        <button class="btn btn-success ms-2" @click="exportExcel">Export Excel</button>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="d-flex justify-content-between align-items-center mb-3">
            <div class="text-muted">
                Menampilkan {{ suppliers.from || 0 }} - {{ suppliers.to || 0 }} dari {{ suppliers.total || 0 }} data
            </div>
            ...
            <div class="table-responsive">
                <table class="table-hover mb-0 table">
                    <thead class="table-light">
                        <tr>
                            ...
                            <th
                                ...
                                @click="isSortable('supplier_code') && handleSort('supplier_code')"
                            ...
                            <th
                                ...
                                @click="isSortable('supplier_name') && handleSort('supplier_name')"
                                style="cursor: pointer"
                            >
                                Nama Supplier
                                <i
                    ...
                    <tbody>
                        ...
                        <tr v-else v-for="(supplier, index) in suppliers.data" :key="supplier.id">
                            <td class="text-muted text-center">
                                {{ suppliers.from + index }}
                            </td>
                            <td>
                                <span class="badge bg-secondary">{{ supplier.supplier_code }}</span>
                            </td>
                            <td class="fw-medium">
